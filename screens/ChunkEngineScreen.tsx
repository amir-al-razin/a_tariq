      ...
      <View
        ...
        <View
          ...
          <View
            style={{
              width: barWidth,
              height: '100%',
              backgroundColor: accent.accent400,
              borderRadius: 8,
            }}
          />
        </View>
        <Text
          style={{
            ...
            fontSize: 13,
            color: isDark ? accent.accent400 : accent.accent700,
            minWidth: 36,
            textAlign: 'right',
          }}>
      ...
      <ScrollView
        ...
        <Text
          style={{
            ...
            fontSize: 22,
            color: isDark ? C.neutral100 : accent.accent800,
            marginBottom: 28,
            textAlign: 'center',
          }}>
          {chunk.titleAr}
        ...
        <View
          style={{
            ...
            borderRadius: 16,
            borderWidth: 1,
            borderColor: isDark ? C.neutral800 : C.neutral200,
      ...
      {isComplete && (
        <View
          style={{
            ...
            paddingBottom: 48,
            borderTopWidth: 1,
            borderTopColor: isDark ? C.neutral800 : C.neutral200,
          }}>
          <Pressable
