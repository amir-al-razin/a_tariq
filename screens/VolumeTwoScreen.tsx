...
import { neutral, vol2 } from '../theme/colors';
        ...
        <View style={{ flex: 1, paddingRight: 12 }}>
          <Text
            style={{
              ...
              fontSize: 13,
              color: isDark ? vol2[400] : vol2[600],
              marginBottom: 6,
            }}>
          ...
          {isCurrent && (
            <Text
              style={{
                fontFamily: 'Lexend_400Regular',
                fontSize: 12,
                color: isDark ? vol2[400] : vol2[500],
                marginTop: 2,
              }}>
              {t('lesson.comingSoon')}
            </Text>
        ...
        <View
          ...
          <View>
            <Text
              style={{
                ...
                fontSize: 28,
                lineHeight: 34,
                color: isDark ? vol2[200] : vol2[700],
              }}>
              {t('volume.vol2Title')}
            </Text>
            <Text
          ...
          <Text
            style={{
              fontFamily: 'NotoSansArabic_600SemiBold',
              fontSize: 22,
              color: isDark ? vol2[300] : vol2[700],
              textAlign: 'right',
            }}>
            الجزء الثاني
          </Text>
