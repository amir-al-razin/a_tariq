...
const ChapterBanner: React.FC<{ chapter: ChapterData; idx: number; isDark: boolean }> = ({
  chapter,
  idx,
  isDark,
}) => {
          ...
          {isCurrent && (
            <Text
              style={{
                fontFamily: 'Lexend_400Regular',
                fontSize: 12,
                color: isDark ? C.primary400 : C.primary500,
                marginTop: 2,
              }}>
              {t('lesson.inProgress')}
            </Text>
        ...
        <View
          ...
          <View>
            <Text
              style={{
                ...
                fontSize: 28,
                lineHeight: 34,
                color: isDark ? C.primary100 : C.primary700,
              }}>
              {t('volume.vol1Title')}
            </Text>
            <Text
          ...
          <Text
            style={{
              fontFamily: 'NotoSansArabic_600SemiBold',
              fontSize: 22,
              color: isDark ? C.primary300 : C.primary700,
              textAlign: 'right',
            }}>
            الجزء الأول
          </Text>
