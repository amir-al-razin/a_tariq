...
export const LESSON_06_STEPS: SessionStep[] = [
  ...
  // 10. Page 38: Authentic Reading & Translation Drill (اقْرَأْ وَتَرْجِمْ)
  {
    ...
    assemblyPayload: {
      ...
      chips: ['This road is wide', 'and', 'that road is narrow', 'this house is clean', 'short'],
      expectedAnswerBn: ['এই রাস্তাটি প্রশস্ত', 'এবং', 'ওই রাস্তাটি সংকীর্ণ'],
      chipsBn: ['এই রাস্তাটি প্রশস্ত', 'এবং', 'ওই রাস্তাটি সংকীর্ণ', 'এই বাড়িটি পরিষ্কার', 'ছোট'],
      emoji: '🛣️',
    },
  },
  ...
  // 13. Page 38: Authentic Reading & Translation Drill 1: The Quran
  {
    ...
    assemblyPayload: {
      ...
      chips: ['The Quran', 'is', 'the Book of Allah', 'the House of Allah', 'a prophet'],
      expectedAnswerBn: ['কুরআন', 'হলো', 'আল্লাহর কিতাব'],
      chipsBn: ['কুরআন', 'হলো', 'আল্লাহর কিতাব', 'আল্লাহর ঘর', 'একজন নবী'],
      emoji: '📖',
    },
  },
  ...
  // 14. Page 38: Authentic Reading & Translation Drill 2: The Kaaba
  {
    ...
    assemblyPayload: {
      ...
      chips: ['The Kaaba', 'is', 'the House of Allah', 'the Book of Allah', 'a mosque'],
      expectedAnswerBn: ['কাবা', 'হলো', 'আল্লাহর ঘর'],
      chipsBn: ['কাবা', 'হলো', 'আল্লাহর ঘর', 'আল্লাহর কিতাব', 'একটি মসজিদ'],
      emoji: '🕋',
    },
  },
  ...
  // 15. Page 38: Authentic Reading & Translation Drill 3: The Messenger
  {
    ...
    assemblyPayload: {
      ...
      chips: ['Muhammad', 'is', 'the Messenger of Allah', 'the Book of Allah', 'a king'],
      expectedAnswerBn: ['মুহাম্মদ', 'হলেন', 'আল্লাহর রাসুল'],
      chipsBn: ['মুহাম্মদ', 'হলেন', 'আল্লাহর রাসুল', 'আল্লাহর কিতাব', 'একজন বাদশাহ'],
      emoji: '🕌',
    },
  },
