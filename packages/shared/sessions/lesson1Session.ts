...
export const LESSON_01_STEPS: SessionStep[] = [
  ...
  // 17. Targeted Cloze Assessment
  {
    ...
    instructionEn: 'Complete the sentence for the indicated object: "That is a car."',
    instructionBn: 'নির্দেশিত বস্তুর জন্য বাক্যটি পূর্ণ করুন: "উহা একটি কার।"',
    itemId: 'pattern:ma_sayyarah',
    clozePayload: {
      questionAr: 'مَا تِلْكَ ؟',
      questionEn: 'What is that? (Car)',
      questionBn: 'উহা কী? (কার / গাড়ি)',
