...
export const CH2_LESSON_02_STEPS: SessionStep[] = [
  ...
  // 10. Sentence Assembly Drill 2: Cup with Cold Water
  {
    id: 'ch2-l2-step-10-assembly-cold-water',
    type: 'sentence_assembly',
    pageNumber: 56,
    titleEn: 'Sentence Building: Cup with Cold Water',
    titleAr: 'تَرْكِيبُ: ذَلِكَ كُوبٌ كَبِيرٌ فِيهِ مَاءٌ بَارِدٌ',
    instructionEn: 'Assemble: "That is a big cup, in it is cold water"',
    instructionBn: 'শব্দগুলো সাজিয়ে লিখুন: "ওটি একটি বড় গ্লাস, তাতে ঠান্ডা পানি আছে"',
    assemblyPayload: {
      promptEn: 'That is a big cup, in it is cold water',
      promptBn: 'ওটি একটি বড় গ্লাস, তাতে ঠান্ডা পানি আছে',
      expectedAnswer: ['ذَلِكَ', 'كُوبٌ', 'كَبِيرٌ', 'فِيهِ', 'مَاءٌ', 'بَارِدٌ'],
      chips: ['ذَلِكَ', 'كُوبٌ', 'كَبِيرٌ', 'فِيهِ', 'مَاءٌ', 'بَارِدٌ', 'حَارٌّ', 'صَغِيرٌ'],
      emoji: '🥛',
    },
  },
  ...
  // 13. Sentence Assembly Drill 4: Precious Necklace in Small Box
  {
    id: 'ch2-l2-step-13-assembly-precious-necklace',
    type: 'sentence_assembly',
    pageNumber: 57,
    titleEn: 'Sentence Building: Precious Necklace',
    titleAr: 'تَرْكِيبُ: هَذَا عِقْدٌ غَالٍ فِي عُلْبَةٍ صَغِيرَةٍ',
    instructionEn: 'Assemble: "This is a precious necklace in a small box"',
    instructionBn: 'শব্দগুলো সাজিয়ে লিখুন: "এটি একটি মূল্যবান হার একটি ছোট কৌটায়"',
    assemblyPayload: {
      promptEn: 'This is a precious necklace in a small box',
      promptBn: 'এটি একটি মূল্যবান হার একটি ছোট কৌটায়',
      expectedAnswer: ['هَذَا', 'عِقْدٌ', 'غَالٍ', 'فِي', 'عُلْبَةٍ', 'صَغِيرَةٍ'],
      chips: ['هَذَا', 'عِقْدٌ', 'غَالٍ', 'فِي', 'عُلْبَةٍ', 'صَغِيرَةٍ', 'كَبِيرَةٍ', 'عَالٍ'],
      emoji: '📿',
    },
  },

  // 14. Sentence Assembly Drill 5: Hot Food in Big Dish
  {
    id: 'ch2-l2-step-14-assembly-hot-food',
    type: 'sentence_assembly',
    pageNumber: 57,
    titleEn: 'Sentence Building: Hot Food in Big Dish',
    titleAr: 'تَرْكِيبُ: ذَلِكَ طَعَامٌ حَارٌّ فِي صَحْنٍ كَبِيرٍ',
    instructionEn: 'Assemble: "That is hot food in a big dish"',
    instructionBn: 'শব্দগুলো সাজিয়ে লিখুন: "ওটি গরম খাবার একটি বড় থালায়"',
    assemblyPayload: {
      promptEn: 'That is hot food in a big dish',
      promptBn: 'ওটি গরম খাবার একটি বড় থালায়',
      expectedAnswer: ['ذَلِكَ', 'طَعَامٌ', 'حَارٌّ', 'فِي', 'صَحْنٍ', 'كَبِيرٍ'],
      chips: ['ذَلِكَ', 'طَعَامٌ', 'حَارٌّ', 'فِي', 'صَحْنٍ', 'كَبِيرٍ', 'بَارِدٌ', 'فِنْجَانٍ'],
      emoji: '🍲',
    },
  },
