...
export const LESSON_07_STEPS: SessionStep[] = [
  ...
  // 13. Page 42: Authentic Reading & Translation Drill 1: Sky & Earth
  {
    ...
    assemblyPayload: {
      ...
      chips: ['The', 'sky', 'is', 'above', 'us', 'and', 'the', 'earth', 'is', 'below', 'us', 'sun', 'bright'],
      expectedAnswerBn: ['আকাশ', 'আমাদের', 'উপরে', 'এবং', 'পৃথিবী', 'আমাদের', 'নিচে'],
      chipsBn: ['আকাশ', 'আমাদের', 'উপরে', 'এবং', 'পৃথিবী', 'আমাদের', 'নিচে', 'সূর্য', 'উজ্জ্বল'],
      emoji: '🌌',
    },
  },
  ...
  // 14. Page 42: Authentic Reading & Translation Drill 2: Custody of Belongings
  {
    ...
    assemblyPayload: {
      ...
      chips: ["Aisha's", 'necklace', 'is', 'with', 'Fatima', 'Mahmud', 'bag'],
      expectedAnswerBn: ['আয়েশার', 'হার', 'ফাতেমার', 'কাছে', 'রয়েছে'],
      chipsBn: ['আয়েশার', 'হার', 'ফাতেমার', 'কাছে', 'রয়েছে', 'মাহমুদের', 'ব্যাগ'],
      emoji: '📿',
    },
  },
  ...
  // 16. Page 42: Authentic Reading & Translation Drill 3: Friend in Front of Mosque
  {
    ...
    assemblyPayload: {
      ...
      chips: ["Bashir's", 'friend', 'is', 'in', 'front', 'of', 'the', 'mosque', 'behind', 'house'],
      expectedAnswerBn: ['বশীরের', 'বন্ধু', 'মসজিদের', 'সামনে', 'আছেন'],
      chipsBn: ['বশীরের', 'বন্ধু', 'মসজিদের', 'সামনে', 'আছেন', 'পেছনে', 'ভেতরে'],
      emoji: '🕌',
    },
  },
