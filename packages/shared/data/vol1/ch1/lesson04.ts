...
export const lesson04: LessonData = {
  ...
  chunks: [
    ...
    },
    {
      ...
      payload: {
        words: [
          { id: 1, ar: 'شَرِيفٌ', romanized: 'sharīfun', en: 'Noble / Gentle', emoji: '🤝' },
          { id: 2, ar: 'مَاهِرٌ', romanized: 'māhirun', en: 'Skilled', emoji: '🎯' },
          { id: 3, ar: 'مَفْتُوحٌ', romanized: 'maftūḥun', en: 'Open', emoji: '🚪' },
          { id: 4, ar: 'مُغْلَقٌ', romanized: 'mughlaqun', en: 'Closed', emoji: '🔒' },
          { id: 5, ar: 'وَاسِعٌ', romanized: "wāsi'un", en: 'Spacious / Wide', emoji: '🏟️' },
          { id: 6, ar: 'ضَيِّقٌ', romanized: 'ḍayyiqun', en: 'Narrow', emoji: '🪜' },
          { id: 7, ar: 'قَوِيٌّ', romanized: 'qawiyyun', en: 'Strong', emoji: '💪' },
          { id: 8, ar: 'ضَعِيفٌ', romanized: "ḍa'īfun", en: 'Weak', emoji: '🪶' },
          { id: 9, ar: 'مُجْتَهِدٌ', romanized: 'mujtahidun', en: 'Hardworking', emoji: '📚' },
          { id: 10, ar: 'مَشْهُورٌ', romanized: 'mashhūrun', en: 'Famous', emoji: '⭐' },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '⌚',
            question_ar: 'كَيْفَ السَّاعَةُ ؟',
            question_en: 'How is the clock?',
            correct_ar: 'السَّاعَةُ جَمِيلَةٌ',
            correct_en: 'The clock is beautiful.',
            options_ar: ['السَّاعَةُ جَمِيلَةٌ', 'السَّاعَةُ قَدِيمَةٌ', 'الْكِتَابُ كَبِيرٌ'],
          },
          {
            emoji: '📚',
            question_ar: 'كَيْفَ التِّلْمِيذُ ؟',
            question_en: 'How is the student?',
            correct_ar: 'التِّلْمِيذُ ذَكِيٌّ',
            correct_en: 'The student is intelligent.',
            options_ar: ['التِّلْمِيذُ ذَكِيٌّ', 'التِّلْمِيذُ ضَعِيفٌ', 'الرَّجُلُ مَاهِرٌ'],
          },
          {
            emoji: '🎒',
            question_ar: 'هَلْ هَذِهِ الْحَقِيبَةُ جَمِيلَةٌ ؟',
            question_en: 'Is this bag beautiful?',
            correct_ar: 'نَعَمْ، هَذِهِ الْحَقِيبَةُ جَمِيلَةٌ',
            correct_en: 'Yes, this bag is beautiful.',
            options_ar: [
              'نَعَمْ، هَذِهِ الْحَقِيبَةُ جَمِيلَةٌ',
              'لَا، هِيَ صَغِيرَةٌ',
              'بَلْ هِيَ قَدِيمَةٌ',
            ],
          },
          {
            emoji: '⌚',
            question_ar: 'هَلْ تِلْكَ السَّاعَةُ جَدِيدَةٌ ؟',
            question_en: 'Is that clock new?',
            correct_ar: 'لَا، تِلْكَ السَّاعَةُ قَدِيمَةٌ',
            correct_en: 'No, that clock is old.',
            options_ar: [
              'نَعَمْ، هِيَ جَدِيدَةٌ',
              'لَا، تِلْكَ السَّاعَةُ قَدِيمَةٌ',
              'بَلْ هِيَ جَمِيلَةٌ',
            ],
          },
        ],
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '📘',
            question_ar: 'كَيْفَ هٰذَا الْكِتَابُ ؟',
            question_en: 'How is this book?',
            correct_ar: 'هٰذَا الْكِتَابُ مُفِيدٌ',
            correct_en: 'This book is useful.',
            options_ar: [
              'هٰذَا الْكِتَابُ مُفِيدٌ',
              'هٰذِهِ الْكِتَابُ مُفِيدَةٌ',
              'هٰذَا كِتَابٌ مُفِيدٌ',
            ],
          },
          {
            emoji: '⌚',
            question_ar: 'كَيْفَ تِلْكَ السَّاعَةُ ؟',
            question_en: 'How is that clock?',
            correct_ar: 'تِلْكَ السَّاعَةُ جَدِيدَةٌ',
            correct_en: 'That clock is new.',
            options_ar: [
              'تِلْكَ السَّاعَةُ جَدِيدَةٌ',
              'ذٰلِكَ السَّاعَةُ جَدِيدٌ',
              'هُوَ جَدِيدٌ',
            ],
          },
          {
            emoji: '👨',
            question_ar: 'مَنْ هٰذَا الرَّجُلُ ؟',
            question_en: 'Who is this man?',
            correct_ar: 'هُوَ مَحْمُودٌ، هُوَ تَاجِرٌ كَبِيرٌ',
            correct_en: 'He is Mahmud, he is a big merchant.',
            options_ar: [
              'هُوَ مَحْمُودٌ، هُوَ تَاجِرٌ كَبِيرٌ',
              'هِيَ مَحْمُودٌ',
              'ذٰلِكَ سَاعَةٌ',
            ],
          },
          {
            emoji: '👩',
            question_ar: 'كَيْفَ الْمَرْأَةُ ؟',
            question_en: 'How is the woman?',
            correct_ar: 'الْمَرْأَةُ شَرِيفَةٌ',
            correct_en: 'The woman is noble.',
            options_ar: ['الْمَرْأَةُ شَرِيفَةٌ', 'الْمَرْأَةُ شَرِيفٌ', 'هُوَ شَرِيفٌ'],
          },
        ],
      },
    },
