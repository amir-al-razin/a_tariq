    ...
    chunks: [
        {
            ...
            payload: {
                words: [
                    ...
                    { id: 3, ar: 'الْمُقَاتَلَةُ / الْقِتَالُ', romanized: 'al-muqātalah / al-qitāl', en: 'Fighting / battling', emoji: '⚔️' },
                    { id: 4, ar: 'الْمُشَاوَرَةُ', romanized: 'al-mushāwarah', en: 'Consulting', emoji: '💬' },
                    { id: 5, ar: 'الْمُسَافَرَةُ', romanized: 'al-musāfarah', en: 'Traveling', emoji: '🧳' },
                    { id: 6, ar: 'الْمُجَاهَدَةُ / الْجِهَادُ', romanized: 'al-mujāhadah / al-jihād', en: 'Striving / Jihad', emoji: '🌟' },
                    { id: 7, ar: 'الْمُجَادَلَةُ / الْجِدَالُ', romanized: 'al-mujādalah / al-jidāl', en: 'Arguing', emoji: '🗣️' },
                    ...
                    { id: 13, ar: 'بِإِذْنِ اللهِ', romanized: 'bi-idhni llāh', en: 'By the will of Allah', emoji: '🕌' },
                    { id: 14, ar: 'بِالنَّفْسِ وَالْمَالِ', romanized: 'bi-n-nafsi wa-l-māl', en: 'With life and wealth', emoji: '💪' },
                ],
            },
        },
        {
            ...
            payload: {
                ...
                masdarRows: [
                    { masdar: 'الْمُسَاعَدَةُ', masdarEn: 'to help', past: 'سَاعَدَ', present: 'يُسَاعِدُ', imperative: 'سَاعِدْ', prohibitive: 'لَا تُسَاعِدْ' },
                    { masdar: 'الْمُهَاجَرَةُ', masdarEn: 'to migrate', past: 'هَاجَرَ', present: 'يُهَاجِرُ', imperative: 'هَاجِرْ', prohibitive: 'لَا تُهَاجِرْ' },
                    { masdar: 'الْمُقَاتَلَةُ', masdarEn: 'to fight', past: 'قَاتَلَ', present: 'يُقَاتِلُ', imperative: 'قَاتِلْ', prohibitive: 'لَا تُقَاتِلْ' },
                    { masdar: 'الْمُسَافَرَةُ', masdarEn: 'to travel', past: 'سَافَرَ', present: 'يُسَافِرُ', imperative: 'سَافِرْ', prohibitive: 'لَا تُسَافِرْ' },
                    { masdar: 'الْمُجَاهَدَةُ', masdarEn: 'to strive', past: 'جَاهَدَ', present: 'يُجَاهِدُ', imperative: 'جَاهِدْ', prohibitive: 'لَا تُجَاهِدْ' },
                    { masdar: 'الْمُجَادَلَةُ', masdarEn: 'to argue', past: 'جَادَلَ', present: 'يُجَادِلُ', imperative: 'جَادِلْ', prohibitive: 'لَا تُجَادِلْ' },
                ],
            },
        },
        {
                ...
                paragraphs: [
                    {
                        ...
                        translationEn: 'The Messenger of Allah ﷺ migrated from Mecca to Al-Madinah Al-Munawwarah. Abu Bakr (RA) migrated with him. O Muslim! Migrate from the land of disbelief to the land of faith.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: 'O young Muslim man! Why do you not fight in the path of Allah? Fight in the path of Allah so that you may enter Paradise. Strive in the path of Allah with your life and your wealth. For indeed, Jihad is the path to Paradise.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: 'Abu Majid traveled to the capital; he wants to return after a week. The traveler returned to his homeland after a year. By the will of Allah, its honor and dignity will return to the Islamic Ummah. O boy! Never return to this matter ever again.',
                    },
                    {
                        lines: [
                    ...
                    },
                    {
                        ...
                        translationEn: 'O good boy! Do not argue with anyone ever. The righteous man obeys the scholar and helps the needy, and does not want reward or thanks from anyone. Indeed, I want to migrate to Allah and His Messenger.',
                    },
                ],
            },
        },
