    ...
    chunks: [
        {
            ...
            payload: {
                words: [
                    ...
                    { id: 4, ar: 'عِشْرُونَ تِلْمِيذًا', romanized: "'ishrūna tilmīdhan", en: 'Twenty male students', emoji: '🔢' },
                    { id: 5, ar: 'ثَلَاثُونَ وَلَدًا', romanized: 'thalāthūna waladan', en: 'Thirty boys', emoji: '🔢' },
                    { id: 6, ar: 'أَرْبَعُونَ مَسْجِدًا', romanized: "arba'ūna masjidan", en: 'Forty mosques', emoji: '🔢' },
                    { id: 7, ar: 'خَمْسُونَ كِتَابًا', romanized: 'khamsūna kitāban', en: 'Fifty books', emoji: '🔢' },
                    { id: 8, ar: 'سِتُّونَ يَوْمًا', romanized: 'sittūna yawman', en: 'Sixty days', emoji: '🔢' },
                    { id: 9, ar: 'سَبْعُونَ قَلَمًا', romanized: "sab'ūna qalaman", en: 'Seventy pens', emoji: '🔢' },
                    { id: 10, ar: 'ثَمَانُونَ رَجُلًا', romanized: 'thamānūna rajulan', en: 'Eighty men', emoji: '🔢' },
                    { id: 11, ar: 'تِسْعُونَ طِفْلًا', romanized: "tis'ūna ṭiflan", en: 'Ninety children', emoji: '🔢' },
                ],
            },
        },
        {
                ...
                paragraphs: [
                    {
                        ...
                        translationEn: 'Twenty scholars established twenty schools in twenty villages. Thirty female writers wrote forty stories in fifty days.',
                    },
                    {
                        ...
                        translationEn: 'Thirteen male students read thirteen stories in thirteen books. Fourteen girls sent nineteen letters to fifteen female friends.',
                    },
                    {
                        ...
                        translationEn: 'Eleven friends bought eleven pens from eleven shops. Eleven female students read eleven stories in eleven magazines. Twelve poets wrote twelve poems in twelve days. Twelve women lit twelve candles in twelve rooms.',
                    },
                    {
                        ...
                        translationEn: 'Rashid has twenty-one books and twenty-one notebooks. I bought twenty-one pens and twenty-one rulers. Twenty-two farmers bought twenty-two plows for twenty-two dirhams.',
                    },
                    {
                        ...
                        translationEn: 'Three boys memorized three parts of the Quran in three months. Eight girls read eight stories in eight hours.',
                    },
                ],
            },
        },
