  ...
  chunks: [
    {
      ...
      payload: {
        ...
        items: [
          { emoji: '🗑️', ar: 'أَلْقَوْا - أَلْقَيْنَ - أَلْقَيْتُمْ - أَلْقَيْتُنَّ - أَلْقَيْنَا', en: 'They threw - You threw - We threw' },
          { emoji: '🗑️', ar: 'يُلْقُونَ - يُلْقِينَ - تُلْقُونَ - تُلْقِينَ - نُلْقِي', en: 'They throw - You throw - We throw' },
          { emoji: '🗑️', ar: 'أَلْقُوا - أَلْقِينَ - لَا تُلْقُوا - لَا تُلْقِينَ', en: 'Throw! - Do not throw!' },
          { emoji: '🕌', ar: 'صَلَّوْا - صَلَّيْنَ - صَلَّيْتُمْ - صَلَّيْتُنَّ - صَلَّيْنَا', en: 'They prayed - You prayed - We prayed' },
          { emoji: '🕌', ar: 'يُصَلُّونَ - يُصَلِّينَ - تُصَلُّونَ - تُصَلِّينَ - نُصَلِّي', en: 'They pray - You pray - We pray' },
          { emoji: '🕌', ar: 'صَلُّوا - صَلِّينَ - لَا تُصَلُّوا - لَا تُصَلِّينَ', en: 'Pray! - Do not pray!' },
          { emoji: '🛒', ar: 'اِشْتَرَوْا - اِشْتَرَيْنَ - اِشْتَرَيْتُمْ - اِشْتَرَيْتُنَّ - اِشْتَرَيْنَا', en: 'They bought - You bought - We bought' },
          { emoji: '🛒', ar: 'يَشْتَرُونَ - يَشْتَرِينَ - تَشْتَرُونَ - تَشْتَرِينَ - نَشْتَرِي', en: 'They buy - You buy - We buy' },
          { emoji: '🛒', ar: 'اِشْتَرُوا - اِشْتَرِينَ - لَا تَشْتَرُوا - لَا تَشْتَرِينَ', en: 'Buy! - Do not buy!' }
        ]
      },
    },
    {
