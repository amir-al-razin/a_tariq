  ...
  chunks: [
    ...
    },
    {
      ...
      payload: {
        ...
        isPlural: true,
        verbTable: [
          { root: 'يَدْعُو', meaning: 'To call', theyM: 'لَنْ يَدْعُوا', theyF: 'لَنْ يَدْعُونَ', youPluralM: 'لَنْ تَدْعُوا', youPluralF: 'لَنْ تَدْعُونَ', we: 'لَنْ نَدْعُوَ' },
          { root: 'يَبْكِي', meaning: 'To cry', theyM: 'لَنْ يَبْكُوا', theyF: 'لَنْ يَبْكِينَ', youPluralM: 'لَنْ تَبْكُوا', youPluralF: 'لَنْ تَبْكِينَ', we: 'لَنْ نَبْكِيَ' },
          { root: 'يَنْسَى', meaning: 'To forget', theyM: 'لَنْ يَنْسَوْا', theyF: 'لَنْ يَنْسَيْنَ', youPluralM: 'لَنْ تَنْسَوْا', youPluralF: 'لَنْ تَنْسَيْنَ', we: 'لَنْ نَنْسَى' },
          { root: 'يُلْقِي', meaning: 'To throw', theyM: 'لَنْ يُلْقُوا', theyF: 'لَنْ يُلْقِينَ', youPluralM: 'لَنْ تُلْقُوا', youPluralF: 'لَنْ تُلْقِينَ', we: 'لَنْ نُلْقِيَ' },
          { root: 'يُصَلِّي', meaning: 'To pray', theyM: 'لَنْ يُصَلُّوا', theyF: 'لَنْ يُصَلِّينَ', youPluralM: 'لَنْ تُصَلُّوا', youPluralF: 'لَنْ تُصَلِّينَ', we: 'لَنْ نُصَلِّيَ' },
          { root: 'يَشْتَرِي', meaning: 'To buy', theyM: 'لَنْ يَشْتَرُوا', theyF: 'لَنْ يَشْتَرِينَ', youPluralM: 'لَنْ تَشْتَرُوا', youPluralF: 'لَنْ تَشْتَرِينَ', we: 'لَنْ نَشْتَرِيَ' }
        ]
      }
    },
    {
      ...
      payload: {
        ...
        questions: [
          ...
          },
          {
            ...
            options_ar: ['أَنْ يَقْرَؤُوا أَخْبَارَ الصَّالِحِينَ لِيَهْتَدُوا بِهَدْيِهِمْ', 'أَنْ يَلْعَبُوا فِى المَلْعَبِ', 'أَنْ يَنَامُوا'],
            questionType: 'general'
          }
        ]
      }
