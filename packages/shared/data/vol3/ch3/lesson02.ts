  ...
  chunks: [
    {
      ...
      payload: {
        words: [
          { id: 1, ar: 'أَجْمَلُ', romanized: 'ajmal', en: 'more/most beautiful', bn: 'অধিক/সবচেয়ে সুন্দর', emoji: '✨' },
          { id: 2, ar: 'أَكْبَرُ', romanized: 'akbar', en: 'bigger/older/biggest', bn: 'অধিক/সবচেয়ে বড়/বয়স্ক', emoji: '📈' },
          { id: 3, ar: 'أَنْظَفُ', romanized: 'anẓaf', en: 'cleaner', bn: 'অধিক পরিষ্কার', emoji: '🧼' },
          { id: 4, ar: 'أَطْوَلُ', romanized: 'aṭwal', en: 'taller/longer', bn: 'অধিক লম্বা', emoji: '📏' },
          { id: 5, ar: 'أَقْصَرُ', romanized: 'aqṣar', en: 'shorter', bn: 'অধিক খাটো', emoji: '📏' },
          { id: 6, ar: 'أَوْسَعُ', romanized: 'awsaʿ', en: 'wider/more spacious', bn: 'অধিক প্রশস্ত', emoji: '↔️' },
          { id: 7, ar: 'أَضْيَقُ', romanized: 'aḍyaq', en: 'narrower', bn: 'অধিক সংকীর্ণ', emoji: '><' },
          { id: 8, ar: 'أَغْلَى', romanized: 'aghlā', en: 'more expensive', bn: 'অধিক দামী', emoji: '💎' },
          { id: 9, ar: 'أَلَذُّ', romanized: 'aladhdh', en: 'tastier', bn: 'অধিক সুস্বাদু', emoji: '😋' },
        ...
        rules: [
          {
            ...
            meaning: 'The pattern أَفْعَلُ is used for comparatives (more than) and superlatives (most). When comparing two items using مِن (than), it stays masculine singular regardless of the subject\'s gender.',
            meaningBn: 'أَفْعَلُ প্যাটার্নটি তুলনামূলক (চেয়ে বেশি) এবং সর্বোচ্চবাচক (সবচেয়ে বেশি) বোঝাতে ব্যবহৃত হয়। مِن (চেয়ে) ব্যবহার করে দুটি জিনিসের তুলনা করার সময়, এটি কর্তার লিঙ্গ নির্বিশেষে পুংলিঙ্গ একবচনে থাকে।',
            examples: [
              { ar: 'خَالِدٌ أَكْبَرُ مِن مَاجِدٍ', en: 'Khalid is older/bigger than Majid', bn: 'খালিদ মাজিদের চেয়ে বড়' },
              { ar: 'عَائِشَةُ أَكْبَرُ مِن فَاطِمَةَ', en: 'Aisha is older/bigger than Fatima', bn: 'আয়েশা ফাতিমার চেয়ে বড়' }
            ]
          }
        ]
      }
      ...
      payload: {
        ...
        questions: [
          ...
          },
          {
            ...
            question_en: 'The spring season is [...] of seasons, because it is the season of flowers.',
