  ...
  chunks: [
    {
      ...
      payload: {
        words: [
          { id: 1, ar: 'اَلِاعْتِمَادُ عَلَى', romanized: 'al-iʿtimādu ʿalā', en: 'To rely on', bn: 'নির্ভর করা', emoji: '🤝' },
          { id: 2, ar: 'اَلْفَوْزُ (بِـ)', romanized: 'al-fawzu (bi-)', en: 'To win / succeed', bn: 'বিজয়ী হওয়া / সফল হওয়া', emoji: '🏆' },
          { id: 3, ar: 'غَرَضٌ', romanized: 'gharaḍ', en: 'Purpose / goal', bn: 'উদ্দেশ্য / লক্ষ্য', emoji: '🎯' },
          { id: 4, ar: 'نَالَ', romanized: 'nāla', en: 'To attain', bn: 'অর্জন করা', emoji: '🏅' },
          { id: 5, ar: 'جَائِزَةٌ', romanized: 'jā\'izah', en: 'Prize / award', bn: 'পুরস্কার', emoji: '🎁' },
          { id: 6, ar: 'قَيِّمَةٌ', romanized: 'qayyimah', en: 'Valuable', bn: 'মূল্যবান', emoji: '💎' },
          { id: 7, ar: 'ضَيَّعَ', romanized: 'ḍayyaʿa', en: 'To waste', bn: 'নষ্ট করা', emoji: '🗑️' },
          { id: 8, ar: 'لَهْوٌ', romanized: 'lahw', en: 'Amusement / distraction', bn: 'খেলাধুলা / বিনোদন', emoji: '🎮' }
        ]
      }
    },
    {
        ...
        rules: [
          {
            ...
            meaning: 'الَّذِي (masc. sing.), الَّتِي (fem. sing. & non-human pl.), الَّذِينَ (masc. pl. rational), اللَّاتِي (fem. pl. rational).',
            meaningBn: 'الَّذِي (পুংলিঙ্গ একবচন), الَّتِي (স্ত্রীলিঙ্গ একবচন ও মানব-ভিন্ন বহুবচন), الَّذِينَ (পুংলিঙ্গ বহুবচন), اللَّاتِي (স্ত্রীলিঙ্গ বহুবচন)।',
            examples: [
              { ar: 'اَلْكِتَابُ الَّذِي عِنْدَ رَاشِدٍ', en: 'The book which is with Rashid', bn: 'যে বইটি রাশিদের কাছে আছে' },
              { ar: 'اَلتَّلَامِيذُ الَّذِينَ يَدْرُسُونَ الْفِقْهَ', en: 'The students who study Fiqh', bn: 'যে ছাত্ররা ফিকহ পড়ে' }
            ]
          },
          {
            ...
            arabic: 'مَنْ / مَا',
            romanized: 'man / mā',
            meaning: 'مَنْ (Whoever / Who) is used for humans regardless of gender/number. مَا (Whatever / That which) is used for non-humans.',
            meaningBn: 'مَنْ (যে কেউ / যে) মানুষের ক্ষেত্রে লিঙ্গ/বচন নির্বিশেষে ব্যবহৃত হয়। مَا (যাই হোক / যা) মানুষের বাইরের ক্ষেত্রে ব্যবহৃত হয়।',
            examples: [
              { ar: 'مَنْ يَعْمَلُ بِعِلْمِهِ', en: 'Whoever acts upon his knowledge', bn: 'যে তার জ্ঞান অনুযায়ী আমল করে' },
      ...
      payload: {
        paragraphs: [
          ...
          },
          {
            ...
            translationEn: 'Whoever acts upon his knowledge is better than whoever does not act upon his knowledge. There is no good in whoever preaches to people and forgets himself. Do not rely on whoever lies. Take from these things what benefits you and leave what does not benefit you. What you kept for yourself will perish, and what you spent in the path of Allah will remain.',
            translationBn: 'যে ব্যক্তি তার জ্ঞান অনুযায়ী আমল করে সে তার চেয়ে উত্তম যে তার জ্ঞান অনুযায়ী আমল করে না। যে ব্যক্তি মানুষকে উপদেশ দেয় আর নিজেকে ভুলে যায় তার মধ্যে কোনো কল্যাণ নেই। যে মিথ্যা বলে তার ওপর নির্ভর করো না। এই জিনিসগুলোর মধ্য থেকে যা তোমার উপকারে আসে তা নাও আর যা উপকারে আসে না তা ছেড়ে দাও। যা তুমি নিজের জন্য রেখেছ তা ধ্বংস হয়ে যাবে, আর যা তুমি আল্লাহর পথে ব্যয় করেছ তা থেকে যাবে।'
          }
        ]
      }
    },
    {
      ...
      payload: {
        instruction: 'Use مَنْ in place of the specific relative pronouns (الذي, الذين, التي, اللاتي).',
        instructionBn: 'নির্দিষ্ট সম্বন্ধবাচক সর্বনামগুলোর (الذي, الذين, التي, اللاتي) পরিবর্তে مَنْ ব্যবহার করুন।',
        questions: [
          {
            emoji: '🔄',
            ...
            options_ar: ['مَنْ يَجْمَعُ الْعِلْمَ خَيْرٌ مِمَّنْ يَجْمَعُ الْمَالَ.', 'مَا يَجْمَعُ الْعِلْمَ خَيْرٌ', 'الَّتِي يَجْمَعُ الْعِلْمَ خَيْرٌ'],
          ...
          },
          {
            ...
            options_ar: ['أُحِبُّ مَنْ يُجَاهِدُونَ فِي سَبِيلِ اللَّهِ.', 'أُحِبُّ مَا يُجَاهِدُونَ', 'يُحِبُّ اللَّهُ مَنْ يُجَاهِدُونَ'],
            questionType: 'general'
          }
        ]
      }
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '📖',
            question_ar: 'يُحِبُّ اللَّهُ الَّذِينَ يَأْكُلُونَ مِنْ كَسْبِهِمْ ، أَمَّا الَّذِينَ يَسْأَلُونَ النَّاسَ فَلَا يُحِبُّهُمُ اللَّهُ.',
            question_en: 'Translate this sentence.',
            question_bn: 'এই বাক্যটি অনুবাদ করুন।',
            correct_ar: 'Allah loves those who eat from their earnings; as for those who beg from people, Allah does not love them.',
            correct_en: 'Allah loves those who eat from their earnings; as for those who beg from people, Allah does not love them.',
            options_ar: ['Allah loves those who eat from their earnings; as for those who beg from people, Allah does not love them.', 'Allah loves whoever prays...', 'Allah loves those who fast...'],
            questionType: 'general'
          }
        ]
      }
