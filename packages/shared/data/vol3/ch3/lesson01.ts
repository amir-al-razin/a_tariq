...
export const lesson01: LessonData = {
  ...
  chunks: [
    ...
    },
    {
      ...
      payload: {
        words: [
          { id: 1, ar: 'بِدَايَةٌ', romanized: 'bidāyah', en: 'Beginning / Start', bn: 'শুরু', emoji: '🏁' },
          { id: 2, ar: 'مَقَامٌ', romanized: 'maqām', en: 'Stage / Position', bn: 'পর্যায় / অবস্থান', emoji: '📍' },
          { id: 3, ar: 'عَوْنٌ', romanized: 'ʿawn', en: 'Help / Assistance', bn: 'সাহায্য', emoji: '🤝' },
          { id: 4, ar: 'فَضْلٌ', romanized: 'faḍl', en: 'Grace / Bounty', bn: 'অনুগ্রহ', emoji: '✨' },
          { id: 5, ar: 'شَمْعَةٌ', romanized: 'shamʿah', en: 'Candle', bn: 'মোমবাতি', emoji: '🕯️' },
          { id: 6, ar: 'تَذْكَرَةٌ', romanized: 'tadhkarah', en: 'Ticket', bn: 'টিকেট', emoji: '🎫' },
          { id: 7, ar: 'اشْتَدَّ', romanized: 'ishtadda', en: 'Intensified', bn: 'তীব্র হয়েছে', emoji: '📈' },
          { id: 8, ar: 'الْإِيذَاءُ', romanized: 'al-īdhā\'', en: 'Harming', bn: 'কষ্ট দেওয়া', emoji: '🤕' }
        ]
      }
    },
    {
        ...
        rules: [
          {
            ...
            meaning: 'The decades have the same form for masculine and feminine. The counted noun must be singular, indefinite, and Mansub.',
            meaningBn: 'দশকগুলো পুংলিঙ্গ এবং স্ত্রীলিঙ্গ উভয়ের জন্য একই রূপের হয়। গণনা করা বিশেষ্যটি একবচন, অনির্দিষ্ট এবং মানসুব হতে হবে।',
            examples: [
              { ar: 'عِشْرُونَ تِلْمِيذًا / تِلْمِيذَةً', en: '20 male/female students', bn: '২০ জন ছাত্র/ছাত্রী' },
              { ar: 'أَرْبَعُونَ مَسْجِدًا / مَدْرَسَةً', en: '40 mosques/schools', bn: '৪০টি মসজিদ/মাদরাসা' },
              { ar: 'خَمْسُونَ كِتَابًا / كُرَّاسَةً', en: '50 books/notebooks', bn: '৫০টি বই/খাতা' }
            ]
          }
        ]
      }
    },
    {
      ...
      payload: {
        ...
        instructionBn: 'দশক ব্যবহার করে বাক্যগুলো পড়ুন।',
        items: [
          { emoji: '🏫', ar: '(أ) أَقَامَ **عِشْرُونَ** عَالِمًا **عِشْرِينَ** مَدْرَسَةً فِي **عِشْرِينَ** قَرْيَةً .', en: 'Twenty scholars established twenty schools in twenty villages.', bn: 'বিশজন আলেম বিশটি গ্রামে বিশটি মাদরাসা স্থাপন করেছেন।' },
          { emoji: '✍️', ar: '(ب) كَتَبَتْ **ثَلَاثُونَ** كَاتِبَةً **أَرْبَعِينَ** قِصَّةً فِي **خَمْسِينَ** يَوْمًا .', en: 'Thirty female writers wrote forty stories in fifty days.', bn: 'ত্রিশজন লেখিকা পঞ্চাশ দিনে চল্লিশটি গল্প লিখেছেন।' },
          { emoji: '📏', ar: '(جـ) عِنْدَ رَاشِدٍ **عِشْرُونَ** قَلَمًا / **ثَلَاثُونَ** مِسْطَرَةً .', en: 'Rashid has twenty pens / thirty rulers.', bn: 'রাশিদের কাছে বিশটি কলম / ত্রিশটি স্কেল আছে।' }
        ]
      }
    },
    {
        ...
        rules: [
          {
            ...
            meaning: 'The first part disagrees with the gender, the second part agrees. Both parts end in Fatha. The noun is singular and Mansub.',
            meaningBn: 'প্রথম অংশটি লিঙ্গের বিপরীত হয়, দ্বিতীয় অংশটি মিলে যায়। উভয় অংশের শেষে ফাতহা হয়। বিশেষ্যটি একবচন এবং মানসুব হয়।',
            examples: [
              { ar: 'ثَلَاثَةَ عَشَرَ رَجُلًا / ثَلَاثَ عَشْرَةَ امْرَأَةً', en: '13 men / 13 women', bn: '১৩ জন পুরুষ / ১৩ জন নারী' },
              { ar: 'أَرْبَعَةَ عَشَرَ كِتَابًا / أَرْبَعَ عَشْرَةَ كُرَّاسَةً', en: '14 books / 14 notebooks', bn: '১৪টি বই / ১৪টি খাতা' }
            ]
          }
        ]
      }
    },
    {
      ...
      payload: {
        ...
        instructionBn: 'যৌগিক সংখ্যা ব্যবহার করে বাক্যগুলো পড়ুন।',
        items: [
          { emoji: '📚', ar: '(أ) قَرَأَ **ثَلَاثَةَ عَشَرَ** تِلْمِيذًا **ثَلَاثَ عَشْرَةَ** قِصَّةً فِي **ثَلَاثَةَ عَشَرَ** كِتَابًا .', en: 'Thirteen male students read thirteen stories in thirteen books.', bn: 'তেরো জন ছাত্র তেরোটি বইয়ে তেরোটি গল্প পড়েছে।' },
          { emoji: '✉️', ar: '(ب) أَرْسَلَتْ **أَرْبَعَ عَشْرَةَ** بِنْتًا إِلَى **خَمْسَ عَشْرَةَ** صَدِيقَةً **تِسْعَ عَشْرَةَ** رِسَالَةً .', en: 'Fourteen girls sent nineteen messages to fifteen female friends.', bn: 'চোদ্দো জন মেয়ে পনেরো জন বান্ধবীর কাছে উনিশটি বার্তা পাঠিয়েছে।' }
        ]
      }
    },
    {
        ...
        rules: [
          {
            ...
            meaning: 'The unit part disagrees with the noun (except 1 & 2), and the tens part remains the same for both genders, joined by \'وَ\'. Noun is singular Mansub.',
            meaningBn: 'এককের অংশটি বিশেষ্যের বিপরীত হয় (১ ও ২ বাদে), এবং দশকের অংশ উভয় লিঙ্গের জন্য একই থাকে, \'وَ\' দ্বারা যুক্ত হয়। বিশেষ্যটি একবচন মানসুব।',
            examples: [
              { ar: 'ثَلَاثَةٌ وَعِشْرُونَ رَجُلًا / ثَلَاثٌ وَعِشْرُونَ امْرَأَةً', en: '23 men / 23 women', bn: '২৩ জন পুরুষ / ২৩ জন নারী' },
              { ar: 'سِتَّةٌ وَعِشْرُونَ مَسْجِدًا / سِتٌّ وَعِشْرُونَ مَدْرَسَةً', en: '26 mosques / 26 schools', bn: '২৬টি মসজিদ / ২৬টি মাদরাসা' }
            ]
          }
        ]
      }
        ...
        rules: [
          {
            ...
            meaning: 'For 11 and 12, both parts agree perfectly with the gender of the counted noun.',
            meaningBn: '১১ এবং ১২ এর ক্ষেত্রে, উভয় অংশ গণনা করা বিশেষ্যের লিঙ্গের সাথে পুরোপুরি মিলে যায়।',
            examples: [
              { ar: 'أَحَدَ عَشَرَ رَجُلًا / إِحْدَى عَشْرَةَ امْرَأَةً', en: '11 men / 11 women', bn: '১১ জন পুরুষ / ১১ জন নারী' },
              { ar: 'اِثْنَا عَشَرَ مَسْجِدًا / اِثْنَتَا عَشْرَةَ مَدْرَسَةً', en: '12 mosques (nom) / 12 schools (nom)', bn: '১২টি মসজিদ (nom) / ১২টি মাদরাসা (nom)' }
            ]
          }
        ]
      }
        ...
        rules: [
          {
            ...
            meaning: 'After 100, 1000, and their multiples, the counted noun must be singular and Genitive (Majrur).',
            meaningBn: '১০০, ১০০০ এবং এদের গুণিতকের পর, গণনা করা বিশেষ্যটি একবচন এবং মাজরুর হতে হবে।',
            examples: [
              { ar: 'مِائَةُ رَجُلٍ / امْرَأَةٍ', en: '100 men / women', bn: '১০০ জন পুরুষ / নারী' },
        ...
        questions: [
          {
            ...
            options_ar: ['أَقَامُوا عِشْرِينَ مَدْرَسَةً', 'كَتَبُوا قِصَّةً', 'ذَهَبُوا إِلَى السُّوقِ'],
          ...
          },
          {
            ...
            options_ar: ['كَتَبْنَ أَرْبَعِينَ قِصَّةً فِي خَمْسِينَ يَوْمًا', 'كَتَبْنَ عِشْرِينَ قِصَّةً', 'كَتَبْنَ عَشْرَ قِصَصٍ'],
            questionType: 'general'
          }
        ]
      }
      ...
      payload: {
        paragraphs: [
          ...
          },
          {
            ...
            translationEn: 'The Fajr prayer is two Rak\'ahs, and the Dhuhr prayer is four Rak\'ahs. Muslims pray five prayers a day, and these five prayers contain seventeen Rak\'ahs, as for the Witr prayer, it is three Rak\'ahs.',
            translationBn: 'ফজরের সালাত দুই রাকাত এবং জোহরের সালাত চার রাকাত। মুসলমানরা দিনে পাঁচ ওয়াক্ত সালাত আদায় করে, এবং এই পাঁচ ওয়াক্ত সালাতে সতেরো রাকাত রয়েছে, আর বিতরের সালাত তিন রাকাত।'
          }
        ]
      }
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '1️⃣',
            question_ar: 'كَمْ سَنَةً دَعَا رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ أَهْلَ مَكَّةَ ؟',
          ...
          {
            emoji: '2️⃣',
            question_ar: 'مَتَى هَاجَرَ الرَّسُولُ وَالَّذِينَ آمَنُوا مَعَهُ إِلَى الْمَدِينَةِ الْمُنَوَّرَةِ ؟',
            question_en: 'When did the Messenger and those who believed with him migrate to Al-Madinah?',
            question_bn: 'রাসূল এবং তাঁর সাথে যারা ঈমান এনেছিল তারা কখন মদীনা মুনাওয়ারায় হিজরত করেন?',
            ...
            options_ar: ['لَمَّا اشْتَدَّ إِيذَاءُ الْمُشْرِكِينَ', 'بَعْدَ شَهْرٍ', 'فِي الصَّبَاحِ'],
            questionType: 'general'
          }
        ]
      }
