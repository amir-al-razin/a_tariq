  ...
  chunks: [
    {
      ...
      payload: {
        words: [
          { id: 1, ar: 'جَمِيْعًا', romanized: 'jamīʿan', en: 'All / Altogether', bn: 'সমস্ত', emoji: '🧑‍🤝‍🧑' },
          { id: 2, ar: 'تَابَ عَلَيْهِ', romanized: 'tāba ʿalayhi', en: 'He accepted repentance / He repented', bn: 'তাওবা মেনে নিল', emoji: '🙏' },
          { id: 3, ar: 'مُجْرِمٌ', romanized: 'mujrim', en: 'Criminal / Sinner', bn: 'পাপী', emoji: '⚖️' },
          { id: 4, ar: 'الإِفْلَاحُ', romanized: 'al-iflāḥ', en: 'Success / Prosperity', bn: 'সাফল্য', emoji: '🏆' },
          { id: 5, ar: 'أُفُقٌ', romanized: 'ufuq', en: 'Horizon', bn: 'क्षितি', emoji: '🌅' },
          { id: 6, ar: 'عَاقِبَةٌ', romanized: 'ʿāqibah', en: 'Consequence / End', bn: 'পরিণাম', emoji: '🔚' },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        verbTable: [
          { root: 'صَامَ', meaning: 'to fast', meaningBn: 'রোযা পালন করা', he: 'صَامَ', she: 'صَامَتْ', youM: 'صُمْتَ', youF: 'صُمْتِ', i: 'صُمْتُ' },
          { root: 'بَاعَ', meaning: 'to sell', meaningBn: 'বিক্রি করা', he: 'بَاعَ', she: 'بَاعَتْ', youM: 'بَعْتَ', youF: 'بَعْتِ', i: 'بَعْتُ' },
          { root: 'نَامَ', meaning: 'to sleep', meaningBn: 'ঘুমানো', he: 'نَامَ', she: 'نَامَتْ', youM: 'نِمْتَ', youF: 'نِمْتِ', i: 'نِمْتُ' },
          { root: 'أَجَابَ', meaning: 'to answer', meaningBn: 'উত্তর দেওয়া', he: 'أَجَابَ', she: 'أَجَابَتْ', youM: 'أَجَبْتَ', youF: 'أَجَبْتِ', i: 'أَجَبْتُ' },
          { root: 'اِسْتَرَاحَ', meaning: 'to rest', meaningBn: 'আরাম করা', he: 'اِسْتَرَاحَ', she: 'اِسْتَرَاحَتْ', youM: 'اِسْتَرَحْتَ', youF: 'اِسْتَرَحْتِ', i: 'اِسْتَرَحْتُ' },
        ],
      },
    },
    {
        ...
        rules: [
          {
            ...
            meaningBn: 'সংখ্যাগুলোর বিভিন্ন সিনট্যাক্স রয়েছে বাক্যের ভূমিকার উপর ভিত্তি করে। উদাহরণ অনুশীলন করে প্যাটার্ন দেখুন।',
            examples: [
