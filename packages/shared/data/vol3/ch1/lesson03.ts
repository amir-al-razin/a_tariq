...
export const lesson03: LessonData = {
  ...
  chunks: [
    ...
    },
    {
      ...
      payload: {
        instruction: 'Complete the following sentences using the verb patterns with purpose (لِـ) and the conjugations shown in the examples, and using the form of the verb that matches the subject.',
        ...
        questions: [
          {
            ...
            correct_ar: 'لِيَكْتُبُوا - لِيَأْكُلُوا - لِيَشْرَبُوا - لِيَجْلِسُوا - لِيَفْتَحُوا - لِيَحْفَظُوا - لِيَسْأَلُوا - لِيَلْعَبُوا',
            correct_en: 'To write - to eat - to drink - to sit - to open - to memorize - to ask - to play',
          ...
          },
          {
            ...
            correct_ar: 'لِيُرْسِلُوا - لِيُعَلِّمُوا - لِيَنْتَظِرُوا - لِيَصُومُوا - لِيَبِيعُوا - لِيُسَافِرُوا - لِيَسْتَرِيحُوا - لِيُجِيبُوا',
            correct_en: 'To send - to teach - to wait - to fast - to sell - to travel - to rest - to answer',
            options_ar: ['لِـ pattern', 'يـ pattern', 'تـ pattern'],
            questionType: 'general'
          }
        ]
