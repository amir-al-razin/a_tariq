    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          ...
          {
            emoji: '📝',
            question_ar: '(٥) أَنْتِ تَدْرُسِينَ اللُّغَةَ الْعَرَبِيَّةَ ___ كَلَامَ اللَّهِ',
            question_en: 'You (f.sg) study the Arabic language to understand the speech of Allah.',
          ...
          {
            emoji: '📝',
            question_ar: '(٦) أَنْتَ تَدْرُسُ اللُّغَةَ الْعَرَبِيَّةَ ___ كَلَامَ اللَّهِ',
            question_en: 'You (m.sg) study the Arabic language to understand the speech of Allah.',
            correct_ar: 'لِتَفْهَمَ',
