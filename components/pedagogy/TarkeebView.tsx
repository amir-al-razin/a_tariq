...
export const TarkeebView: React.FC<PedagogyProps> = ({
  isDark,
  C,
  payload,
  onProgress,
  ...
  if (items.length === 0) {
    ...
    return (
      <Text style={{ color: isDark ? C.neutral400 : C.neutral500 }}>{t('tarkeeb.noData')}</Text>
    );
  }
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              {item.type === 'complete'
                ? t('tarkeeb.completeSentence')
                : t('tarkeeb.incompletePhrase')}
            </Text>
          </View>
          ...
          <ScrollView
            ...
            <View
              style={{ flexDirection: 'row', alignItems: 'flex-start', gap: 16, minHeight: 80 }}>
