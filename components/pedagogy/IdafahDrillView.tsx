...
export const IdafahDrillView: React.FC<PedagogyProps> = ({
  isDark,
  C,
  payload,
  onProgress,
    ...
    <View style={{ width: '100%', gap: 12 }}>
      ...
      <View style={{ flexDirection: 'row', gap: 8 }}>
        <View
          ...
          <Text style={{ fontFamily: 'Lexend_600SemiBold', fontSize: 11, color: textSub }}>
            {t('idafah.basePhrase')}
          </Text>
        </View>
        <View
      ...
      {revealed.some((r) => !r) && (
        <Pressable
          ...
          style={{
            ...
            borderRadius: 20,
            borderWidth: 1,
            borderColor: isDark ? C.neutral600 : C.neutral300,
          }}>
          <Text style={{ fontFamily: 'Lexend_400Regular', fontSize: 12, color: textSub }}>
            {t('idafah.revealAll')}
          </Text>
