...
type PedagogyProps = {
  isDark: boolean;
  C: ColorMap;
  payload?: { rules?: GrammarRule[] };
  onProgress?: (v: number) => void;
  onComplete?: () => void;
};

export const GrammarRuleView: React.FC<PedagogyProps> = ({ isDark, C, payload }) => {
      ...
      {rules.map((rule, i) => (
        <View
          ...
          style={{
            ...
            borderWidth: 1,
            borderColor:
              i === 0 ? (isDark ? C.primary800 : '#A7F3DE') : isDark ? C.neutral700 : C.neutral200,
          }}>
          {(() => {
            ...
            return (
              <Text
                style={{
                  ...
                  fontSize: 11,
                  color: i === 0 ? C.primary700 : isDark ? C.neutral400 : C.neutral500,
                  marginBottom: 8,
                  letterSpacing: 0.5,
                }}>
                {labelText}
          ...
          <View style={{ alignItems: 'center', marginBottom: 12 }}>
            <Text
              style={{
                ...
                fontSize: 32,
                color: i === 0 ? C.primary700 : isDark ? C.neutral300 : C.neutral700,
                marginBottom: 6,
              }}>
              {rule.arabic}
            </Text>
          ...
          {rule.examples?.map((ex, j) => (
            <View
              ...
              style={{
                borderTopWidth: 1,
                borderTopColor: isDark ? C.neutral700 : C.neutral200,
                paddingTop: 10,
                marginTop: j === 0 ? 0 : 8,
              }}>
              <Text
