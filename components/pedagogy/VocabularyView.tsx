...
export const VocabularyView: React.FC<PedagogyProps> = ({
  isDark,
  C,
  payload,
  onProgress,
        ...
        {!flipped ? (
          <View
            style={{
              flex: 1,
              minHeight: 200,
              backgroundColor: isDark ? C.neutral900 : '#ECFDF8',
              alignItems: 'center',
          ...
          <View
            style={{
              flex: 1,
              minHeight: 200,
              backgroundColor: isDark ? C.neutral800 : C.neutral50,
              alignItems: 'center',
              justifyContent: 'center',
              padding: 24,
            }}>
        ...
        <Pressable
          ...
          <Text
            style={{
              fontFamily: 'Lexend_600SemiBold',
              fontSize: 14,
              color: done ? (isDark ? C.neutral500 : C.neutral500) : '#fff',
            }}>
            {!flipped
              ? t('vocabulary.reveal')
              : isLast
          ...
          <Ionicons
            name={!flipped ? 'eye-outline' : isLast ? 'checkmark' : 'arrow-forward'}
            size={18}
            color={done ? (isDark ? C.neutral500 : C.neutral500) : '#fff'}
          />
        </Pressable>
