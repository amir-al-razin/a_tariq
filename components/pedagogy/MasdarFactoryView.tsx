...
import type { MasdarRow } from '../../data/curriculum';
...
export const MasdarFactoryView: React.FC<PedagogyProps> = ({
  isDark,
  C,
  payload,
  onProgress,
        ...
        <View style={{ gap: 0 }}>
          ...
          <View
            ...
            <View
              ...
              <Text
                style={{ fontFamily: 'NotoSansArabic_600SemiBold', fontSize: 13, color: accentAr }}>
                مَصْدَر
              </Text>
      ...
      <View
        ...
        {COLS.map((col) => (
          <View
            ...
            <Text
              style={{ fontFamily: 'NotoSansArabic_600SemiBold', fontSize: 11, color: accentAr }}>
              {col.arLabel}
            </Text>
