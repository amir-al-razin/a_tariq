...
export const VerbTableView: React.FC<PedagogyProps> = ({
  isDark,
  C,
  payload,
  onProgress,
  ...
  if (rows.length === 0) {
    ...
    return (
      <Text style={{ color: isDark ? C.neutral400 : C.neutral500 }}>{t('verbTable.noData')}</Text>
    );
  }
  ...
  return (
    <View style={{ width: '100%', gap: 16 }}>
      ...
      {payload?.instruction && (
        <View
          style={{
            backgroundColor: isDark ? '#0D775F22' : '#D1FAF0',
            borderRadius: 8,
            padding: 10,
          }}>
          <Text
            style={{
              ...
              fontSize: 12,
              color: isDark ? C.primary400 : C.primary700,
              textAlign: 'center',
            }}>
            {payload.instruction}
          </Text>
        ...
        <View style={{ gap: 16, paddingBottom: 8 }}>
          ...
          <View
            ...
            <View
              ...
              <Text style={{ fontFamily: 'Lexend_600SemiBold', fontSize: 10, color: textSub }}>
                {t('verbTable.root')}
              </Text>
              <Text style={{ fontFamily: 'Lexend_400Regular', fontSize: 9, color: textSub }}>
                {t('verbTable.meaning')}
              </Text>
            </View>
            {COL_HEADERS.map((h, i) => (
              <View
                ...
                style={{
                  ...
                  padding: 4,
                  alignItems: 'center',
                  borderRightWidth: i < COL_HEADERS.length - 1 ? 1 : 0,
                  borderRightColor: border,
                }}>
                <Text
                  style={{
                ...
                <Text style={{ fontFamily: 'Lexend_400Regular', fontSize: 8, color: textSub }}>
                  {t(h.labelKey)}
                </Text>
              </View>
            ))}
