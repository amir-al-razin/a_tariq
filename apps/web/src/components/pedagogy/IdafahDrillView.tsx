  ...
  return (
    <div className="w-full flex flex-col gap-3">
      ...
      <div className="flex flex-row gap-2">
        <div className="flex-1 bg-neutral-200 dark:bg-neutral-700 rounded-lg p-2 flex items-center justify-center">
      ...
      {revealed.some((r) => !r) && (
        <button
          onClick={revealAll}
          className="self-center mt-1 px-4 py-2 rounded-full border border-neutral-300 dark:border-neutral-600 bg-transparent cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors"
        >
