...
{parts.map((part, pIdx) => (
 <div 
 key={pIdx} 
 className="flex-1 flex items-center justify-center min-w-[80px] bg-white dark:bg-neutral-900 rounded-lg py-2.5 px-3"
 >
...
{/* Column headers */}
 <div className="flex flex-row rounded-lg overflow-hidden bg-neutral-200 dark:bg-neutral-800">
{/* Root column header */}
 <div className="w-20 p-1.5 flex flex-col items-center justify-center bg-neutral-200 dark:bg-neutral-800 shrink-0">
...
{COL_HEADERS.map((h, i) => (
 <div
 key={i}
 className={`flex-1 min-w-[85px] p-1 flex flex-col items-center shrink-0 bg-neutral-200 dark:bg-neutral-800 ${
...
{rows.map((row, idx) => (
 ...
 >
{/* Root + meaning */}
 <div className="w-20 p-1.5 flex flex-col items-center justify-center bg-white dark:bg-neutral-900 shrink-0">
 <span
...
{(isDual || isPlural 
 ...
 <div
 key={i}
 className={`flex-1 min-w-[85px] p-1.5 flex items-center justify-center bg-white dark:bg-neutral-900 shrink-0 ${
 i < 4 ? ' ' : ''
}`}
 >
 <span
