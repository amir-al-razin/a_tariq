...
export const QAndAView: React.FC<Props> = ({ payload, onProgress, onComplete }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      {/* Emoji */}
      <div className="w-24 h-24 rounded-2xl bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 flex items-center justify-center mb-5">
