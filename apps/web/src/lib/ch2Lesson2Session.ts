...
export const CH2_LESSON_02_STEPS: SessionStep[] = [
  ...
  // 8. Dialogic Alternative Q&A Battery 1: Object Observation & Quality Verification (Page 57)
  {
    id: 'ch2-l2-step-8-alt-qa-inquiry-1',
    type: 'alternative_qa',
    pageNumber: 57,
    ...
    alternativeQAPayload: {
      questions: [
        {
          id: 'qa-c2l2-1',
          questionAr: 'هَلْ هَذَا قَلَمٌ جَيِّدٌ ؟',
          visualCue: '🖊️✨',
        ...
        {
          id: 'qa-c2l2-2',
          questionAr: 'هَلْ ذَلِكَ مِفْتَاحٌ كَبِيرٌ ؟',
          visualCue: '🗝️',
          contextBn: 'প্রেক্ষাপট: এটি একটি ছোট চাবি',
          contextEn: 'Premise: It is a small key',
  ...
  // 10. Authentic Reading & Translation Drill: Cup with Cold Water
  {
    ...
    assemblyPayload: {
      ...
      chips: ['That', 'is', 'a', 'big', 'cup', 'in', 'it', 'is', 'cold', 'water', 'hot', 'tea', 'plate'],
      expectedAnswerBn: ['ওটি', 'একটি', 'বড়', 'গ্লাস', 'তাতে', 'রয়েছে', 'ঠান্ডা', 'পানি'],
      chipsBn: ['ওটি', 'একটি', 'বড়', 'গ্লাস', 'তাতে', 'রয়েছে', 'ঠান্ডা', 'পানি', 'গরম', 'চা', 'থালা'],
      emoji: '🥛',
    },
  },
  ...
  // 12. Dialogic Alternative Q&A Battery 2: Descriptive Alternative Choices (Page 59)
  {
    ...
    alternativeQAPayload: {
      contextAr: 'هَذَا مِفْتَاحٌ كَبِيرٌ',
      contextEn: 'Premise: This is a big key',
      contextBn: 'প্রেক্ষাপট: এটি একটি বড় চাবি',
      questions: [
        {
          id: 'qa-c2l2-6',
          questionAr: 'أَ مِفْتَاحٌ كَبِيرٌ هَذَا أَمْ مِفْتَاحٌ صَغِيرٌ ؟',
          optionsAr: ['مِفْتَاحٌ كَبِيرٌ', 'مِفْتَاحٌ صَغِيرٌ'],
          correctAnswerAr: 'مِفْتَاحٌ كَبِيرٌ',
        },
        {
          id: 'qa-c2l2-7',
          questionAr: 'أَ مِفْتَاحٌ صَغِيرٌ هَذَا أَمْ مِفْتَاحٌ كَبِيرٌ ؟',
          optionsAr: ['مِفْتَاحٌ كَبِيرٌ', 'مِفْتَاحٌ صَغِيرٌ'],
          correctAnswerAr: 'مِفْتَاحٌ كَبِيرٌ',
        },
        {
          id: 'qa-c2l2-8',
          questionAr: 'أَ مَاءٌ بَارِدٌ هَذَا أَمْ حَارٌّ ؟',
          visualCue: '💧❄️',
          contextAr: 'هَذَا مَاءٌ بَارِدٌ',
          contextBn: 'প্রেক্ষাপট: এটি ঠান্ডা পানি',
          contextEn: 'Premise: This is cold water',
          optionsAr: ['مَاءٌ بَارِدٌ', 'مَاءٌ حَارٌّ'],
        ...
        },
        {
          ...
          visualCue: '🍯',
          contextAr: 'هَذَا عَسَلٌ خَالِصٌ',
          contextBn: 'প্রেক্ষাপট: এটি খাঁটি মধু',
          contextEn: 'Premise: This is pure honey',
          optionsAr: ['عَسَلٌ خَالِصٌ', 'عَسَلٌ فَاسِدٌ'],
        ...
        },
        {
          ...
          visualCue: '🐟✨',
          contextAr: 'تِلْكَ سَمَكَةٌ طَازَجَةٌ',
          contextBn: 'প্রেক্ষাপট: ওটি তাজা মাছ',
          contextEn: 'Premise: That is fresh fish',
          optionsAr: ['سَمَكَةٌ طَازَجَةٌ', 'سَمَكَةٌ فَاسِدَةٌ'],
  ...
  // 13. Authentic Reading & Translation Drill: Precious Necklace in Small Box
  {
    ...
    assemblyPayload: {
      ...
      chips: ['This', 'is', 'a', 'precious', 'necklace', 'in', 'a', 'small', 'box', 'room', 'ring', 'cheap'],
      expectedAnswerBn: ['এটি', 'একটি', 'মূল্যবান', 'হার', 'একটি', 'ছোট', 'কৌটায়'],
      chipsBn: ['এটি', 'একটি', 'মূল্যবান', 'হার', 'একটি', 'ছোট', 'কৌটায়', 'বড়', 'ঘরে', 'সস্তা'],
      emoji: '📿',
    },
  },
  ...
  // 14. Authentic Reading & Translation Drill: Hot Food in Big Dish
  {
    ...
    assemblyPayload: {
      ...
      chips: ['That', 'is', 'hot', 'food', 'in', 'a', 'big', 'dish', 'cold', 'water', 'cup'],
      expectedAnswerBn: ['ওটি', 'গরম', 'খাবার', 'একটি', 'বড়', 'থালায়'],
      chipsBn: ['ওটি', 'গরম', 'খাবার', 'একটি', 'বড়', 'থালায়', 'ঠান্ডা', 'পানি', 'পাত্রে'],
      emoji: '🍲',
    },
  },
