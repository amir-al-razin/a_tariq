...
export const LESSON_09_STEPS: SessionStep[] = [
  ...
  // 9. Page 46: Authentic Reading & Translation Drill 1: Capital Airport
  {
    ...
    assemblyPayload: {
      ...
      chips: ['In', 'the', 'capital', 'airport', 'is', 'a', 'big', 'airplane', 'fast', 'car'],
      expectedAnswerBn: ['রাজধানীর', 'বিমানবন্দরে', 'একটি', 'বড়', 'উড়োজাহাজ', 'আছে'],
      chipsBn: ['রাজধানীর', 'বিমানবন্দরে', 'একটি', 'বড়', 'উড়োজাহাজ', 'আছে', 'দ্রুতগামী', 'গাড়ি'],
      emoji: '✈️',
    },
  },
  ...
  // 10. Page 46: Authentic Reading & Translation Drill 2: Airplane Speed
  {
    ...
    assemblyPayload: {
      ...
      chips: ['This', 'airplane', 'is', 'very', 'fast', 'slow', 'old'],
      expectedAnswerBn: ['এই', 'উড়োজাহাজটি', 'খুব', 'দ্রুতগামী'],
      chipsBn: ['এই', 'উড়োজাহাজটি', 'খুব', 'দ্রুতগামী', 'ধীরগতির', 'পুরনো'],
      emoji: '⚡',
    },
  },
  ...
  // 12. Page 46: Authentic Reading & Translation Drill 3: Book in Zainab’s Hand
  {
    ...
    assemblyPayload: {
      ...
      chips: ['In', 'Zainab’s', 'hand', 'is', 'a', 'beautiful', 'book', 'clean', 'bag'],
      expectedAnswerBn: ['যয়নবের', 'হাতে', 'একটি', 'সুন্দর', 'বই', 'আছে'],
      chipsBn: ['যয়নবের', 'হাতে', 'একটি', 'সুন্দর', 'বই', 'আছে', 'পরিষ্কার', 'রুমাল'],
      emoji: '📖',
    },
  },
  ...
  // 13. Page 46: Authentic Reading & Translation Drill 4: Bashir’s Garden
  {
    ...
    assemblyPayload: {
      ...
      chips: ['In', 'Bashir’s', 'garden', 'is', 'a', 'big', 'rose', 'tall', 'tree'],
      expectedAnswerBn: ['বশীরের', 'বাগানে', 'একটি', 'বড়', 'গোলাপ', 'আছে'],
      chipsBn: ['বশীরের', 'বাগানে', 'একটি', 'বড়', 'গোলাপ', 'আছে', 'উঁচু', 'গাছ'],
      emoji: '🌹',
    },
  },
  ...
  // 16. Page 46: Authentic Reading & Translation Drill 5: Khadijah’s Handkerchief
  {
    ...
    assemblyPayload: {
      ...
      chips: ['Her', 'handkerchief', 'is', 'in', 'her', 'hand', 'and', 'it', 'is', 'clean', 'new', 'desk'],
      expectedAnswerBn: ['তার', 'রুমাল', 'তার', 'হাতে', 'এবং', 'তা', 'পরিষ্কার'],
      chipsBn: ['তার', 'রুমাল', 'তার', 'হাতে', 'এবং', 'তা', 'পরিষ্কার', 'নতুন', 'টেবিলের'],
      emoji: '🤲',
    },
  },
