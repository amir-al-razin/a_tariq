...
export const CH2_LESSON_07_STEPS: SessionStep[] = [
  ...
  // 14. Sentence Assembly Drill 1: Table Items
  {
    id: 'ch2-l7-step-14-assembly-table-items',
    type: 'sentence_assembly',
    pageNumber: 82,
    titleEn: 'Sentence Assembly: Items Upon Table',
    titleAr: 'تَرْكِيبُ: فَوْقَ الطَّاوِلَةِ كِتَابٌ وَ قَلَمٌ',
    instructionEn: 'Assemble: "On the table is a book and a pen."',
    instructionBn: 'শব্দগুলো সাজিয়ে লিখুন: "টেবিলের উপরে একটি বই এবং একটি কলম আছে।"',
    assemblyPayload: {
      promptEn: 'On the table is a book and a pen.',
      promptBn: 'টেবিলের উপরে একটি বই এবং একটি কলম আছে।',
      expectedAnswer: ['فَوْقَ', 'الطَّاوِلَةِ', 'كِتَابٌ', 'وَ', 'قَلَمٌ'],
      chips: ['فَوْقَ', 'الطَّاوِلَةِ', 'كِتَابٌ', 'وَ', 'قَلَمٌ', 'تَحْتَ', 'سَبُّورَةٌ'],
      emoji: '📝',
    },
  },

  // 15. Sentence Assembly Drill 2: Teacher & Blackboard
  {
    id: 'ch2-l7-step-15-assembly-teacher-board',
    type: 'sentence_assembly',
    pageNumber: 82,
    titleEn: 'Sentence Assembly: Teacher & Duster Positions',
    titleAr: 'تَرْكِيبُ: الْمُعَلِّمُ أَمَامَ السَّبُّورَةِ',
    instructionEn: 'Assemble: "The teacher is in front of the blackboard and the duster is on the table."',
    instructionBn: 'শব্দগুলো সাজিয়ে লিখুন: "শিক্ষক ব্ল্যাকবোর্ডের সামনে এবং ডাস্টারটি টেবিলের উপরে।"',
    assemblyPayload: {
      ...
      expectedAnswer: ['الْمُعَلِّمُ', 'أَمَامَ', 'السَّبُّورَةِ', 'وَ', 'الْمِسَّاحَةُ', 'فَوْقَ', 'الطَّاوِلَةِ'],
      chips: ['الْمُعَلِّمُ', 'أَمَامَ', 'السَّبُّورَةِ', 'وَ', 'الْمِسَّاحَةُ', 'فَوْقَ', 'الطَّاوِلَةِ', 'تَحْتَ'],
      emoji: '🧑‍🏫',
    },
  },

  // 16. Sentence Assembly Drill 3: River, Bridge & Boat
  {
    id: 'ch2-l7-step-16-assembly-bridge-boat',
    type: 'sentence_assembly',
    pageNumber: 83,
    titleEn: 'Sentence Assembly: Bridge & Navigating Boat',
    titleAr: 'تَرْكِيبُ: فَوْقَ النَّهْرِ جِسْرٌ وَ تَحْتَ الْجِسْرِ زَوْرَقٌ',
    instructionEn: 'Assemble: "Above the river is a bridge and under the bridge is a boat."',
    instructionBn: 'শব্দগুলো সাজিয়ে লিখুন: "নদীর উপরে একটি সেতু এবং সেতুর নিচে একটি নৌকা রয়েছে।"',
    assemblyPayload: {
      ...
      expectedAnswer: ['فَوْقَ', 'النَّهْرِ', 'جِسْرٌ', 'وَ', 'تَحْتَ', 'الْجِسْرِ', 'زَوْرَقٌ'],
      chips: ['فَوْقَ', 'النَّهْرِ', 'جِسْرٌ', 'وَ', 'تَحْتَ', 'الْجِسْرِ', 'زَوْرَقٌ', 'كَبِيرٌ'],
      emoji: '🌉',
    },
  },
