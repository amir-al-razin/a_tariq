...
export const CH2_LESSON_07_STEPS: SessionStep[] = [
  ...
  // 13. Speed Pair Matching 2: Spatial Clauses
  {
    ...
    instructionBn: 'স্থান বা অবস্থান নির্দেশক শব্দগুচ্ছের সাথে তাদের অনুবাদের দ্রুত মিল করুন।',
    pairPayload: {
      pairs: [
        { id: 'p-c2l7-7', ar: 'فَوْقَ الْمِنْضَدَةِ', meaning: 'On the table' },
        { id: 'p-c2l7-8', ar: 'تَحْتَ السَّرِيرِ', meaning: 'Under the bed' },
        { id: 'p-c2l7-9', ar: 'أَمَامَ الْمَسْجِدِ', meaning: 'In front of the mosque' },
        { id: 'p-c2l7-10', ar: 'خَلْفَ الْبَابِ', meaning: 'Behind the door' },
        { id: 'p-c2l7-11', ar: 'عِنْدَ الْأُسْتَاذِ', meaning: 'With the teacher' },
      ],
    },
  },
