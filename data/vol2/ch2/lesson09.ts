  ...
  chunks: [
        ...
        rules: [
          {
            ...
            meaning:
              'When a non-human noun is pluralized, its adjectives and demonstrative pronouns change to singular feminine form.',
            examples: [
          ...
          },
          {
            ...
            meaning:
              'Color adjectives (diptotes) normally take fathah in the genitive. However, when prefixed with the definite article ال, they accept a standard kasrah.',
            examples: [
    ...
    },
    {
      ...
      payload: {
        verbTense: 'past',
        instruction:
          'Plural conjugations for memorization — apply the same pattern to فَتَحَ, ضَرَبَ, سَمِعَ',
        verbTable: [
          {
            root: 'نَصَرَ',
            meaning: 'to help',
            he: 'نَصَرُوا (m) / نَصَرْنَ (f)',
            she: 'يَنْصُرُونَ (m) / يَنْصُرْنَ (f)',
            youM: 'نَصَرْتُمْ (m) / نَصَرْتُنَّ (f)',
            youF: 'تَنْصُرُونَ (m) / تَنْصُرْنَ (f)',
            i: 'نَصَرْنَا / نَنْصُرُ',
          },
        ],
      },
    },
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'The past day will never return — the past days will never return. The vacation days have passed — the vacation has ended. I returned to school after spending the beautiful vacation days between my father and mother and between my brothers and sisters.',
          },
          {
          ...
          },
          {
            ...
            translationEn:
              "Fatima bought beautiful flowers from the flower shop to decorate her room with them. Fatima's clothes were beautiful and she used to wear clean clothes.",
          },
        ],
      },
    },
