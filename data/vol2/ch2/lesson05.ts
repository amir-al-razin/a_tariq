  ...
  chunks: [
    {
      ...
      payload: {
        ...
        masdarRows: [
          {
            masdar: 'الْإِلْقَاءُ',
            masdarEn: 'throwing / casting',
            past: 'أَلْقَى',
            present: 'يُلْقِي',
            imperative: 'أَلْقِ',
            prohibitive: 'لَا تُلْقِ',
          },
          {
            masdar: 'الْإِعْطَاءُ',
            masdarEn: 'giving',
            ...
            present: 'يُعْطِي',
            imperative: 'أَعْطِ',
            prohibitive: 'لَا تُعْطِ',
          },
          {
            masdar: 'الْإِخْفَاءُ',
            masdarEn: 'hiding / concealing',
            past: 'أَخْفَى',
            present: 'يُخْفِي',
            imperative: 'أَخْفِ',
            prohibitive: 'لَا تُخْفِ',
          },
          {
            masdar: 'الْإِفْنَاءُ',
            masdarEn: 'destroying / annihilating',
            past: 'أَفْنَى',
            present: 'يُفْنِي',
            imperative: 'أَفْنِ',
            prohibitive: 'لَا تُفْنِ',
          },
          {
            masdar: 'الْإِبْكَاءُ',
            masdarEn: 'making someone cry',
            past: 'أَبْكَى',
            present: 'يُبْكِي',
            imperative: 'أَبْكِ',
            prohibitive: 'لَا تُبْكِ',
          },
          {
            masdar: 'الْإِبْقَاءُ',
            masdarEn: 'keeping / sparing',
            past: 'أَبْقَى',
            present: 'يُبْقِي',
            imperative: 'أَبْقِ',
            prohibitive: 'لَا تُبْقِ',
          },
          {
            masdar: 'الْإِنْجَاءُ',
            masdarEn: 'rescuing / saving',
            past: 'أَنْجَى',
            present: 'يُنْجِي',
            imperative: 'أَنْجِ',
            prohibitive: 'لَا تُنْجِ',
          },
          {
            masdar: 'الْإِحْيَاءُ',
            masdarEn: 'giving life',
            past: 'أَحْيَا',
            present: 'يُحْيِي',
            imperative: 'أَحْيِ',
            prohibitive: 'لَا تُحْيِ',
          },
          {
            masdar: 'الْإِنْسَاءُ',
            masdarEn: 'making someone forget',
            past: 'أَنْسَى',
            present: 'يُنْسِي',
            imperative: 'أَنْسِ',
            prohibitive: 'لَا تُنْسِ',
          },
        ],
      },
    },
        ...
        rules: [
          {
            ...
            meaning:
              'Form IV defective verbs follow the pattern أَفْعَلَ يُفْعِلُ. The masdar follows إِفْعَال. Apply the same conjugation pattern to all verbs in this group.',
            examples: [
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'Allah commanded Musa to throw his staff on the ground, and said: "Throw it, O Musa!" So Musa threw his staff on the ground, and a snake appeared moving, and Musa feared the snake. Allah said to him: "Take it and do not fear," so Musa took it, and it returned to its form as a staff. Allah commanded the mother of Musa to throw her child into the Nile, so the mother of Musa threw her child into the Nile.',
          },
          {
            ...
            translationEn:
              'Ibrahim said: "My Lord gives life and causes death." The arrogant king said: "I give life and cause death." The king was foolish and did not know the meaning of life and death.',
          },
          {
            ...
            translationEn:
              'The teacher said to his student: "Always be truthful and never lie, for indeed truth saves a person and lying destroys him."',
          },
        ],
      },
    },
