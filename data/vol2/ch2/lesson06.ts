    ...
    },
    {
      ...
      payload: {
        ...
        masdarRows: [
          {
            masdar: 'الْإِتْيَانُ',
            masdarEn: 'coming / to come',
            past: 'أَتَى',
            present: 'يَأْتِي',
            imperative: 'اِئْتِ',
            prohibitive: 'لَا تَأْتِ',
          },
        ],
      },
    },
        ...
        rules: [
          {
            ...
            meaning:
              'The particle أَنْ followed by a present tense verb creates the meaning of a verbal noun (masdar). This is called the interpreted masdar (الْمَصْدَرُ الْمُؤَوَّل).',
            examples: [
              ...
              {
                ar: 'أَنْ تَغْفُلُوا عَنِ الْمَوْتِ شَرٌّ لَكُمْ',
                en: 'That you are heedless of death is bad for you.',
              },
            ],
          },
          {
            ...
            examples: [{ ar: 'أَمَرَهُ أَلَّا يَذْهَبَ', en: 'He commanded him not to go.' }],
          },
          {
            ...
            meaning:
              'لَمَّا is used only with the past tense. عِنْدَمَا can be used with both past and present tense.',
            examples: [
              {
                ar: 'لَمَّا سَمِعَ الشُّبَّانُ نِدَاءَ الْجِهَادِ طَارُوا إِلَى سَاحَةِ الْقِتَالِ',
                en: 'When the young men heard the call to Jihad, they flew to the battlefield.',
              },
              {
                ar: 'عِنْدَمَا يَسْمَعُ الشُّبَّانُ نِدَاءَ الْجِهَادِ يَطِيرُونَ إِلَى سَاحَةِ الْقِتَالِ',
                en: 'When the young men hear the call to Jihad, they fly to the battlefield.',
              },
            ],
          },
        ],
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'That you maintain ties of kinship is better for you. That you give charity is better for you. That you learn the Arabic language is better for you. That you obey Allah and His Messenger is better for you. That you are heedless of death is bad for you. That you waste your lives is bad for you.',
          },
          {
            lines: [
            ...
            translationEn:
              'Your happiness is in that you serve your mother. Your loss is in that you forget your Hereafter. Your success is in that you please your Lord. Your salvation is in that you strive for your Hereafter.',
          },
          {
            lines: [
            ...
            translationEn:
              'It opens the door of happiness for you that you obey your father and your mother. It drives people to ruin that they obey Satan. It pleases me that you speak in eloquent Arabic. It saddens me that you waste your times which pass and never return.',
          },
        ],
      },
    },
