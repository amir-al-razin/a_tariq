  ...
  chunks: [
    {
      ...
      payload: {
        ...
        masdarRows: [
          {
            masdar: 'الدَّعْوَةُ',
            masdarEn: 'calling / inviting',
            baab: 'ن',
            past: 'دَعَا',
            present: 'يَدْعُو',
            imperative: 'اُدْعُ',
            prohibitive: 'لَا تَدْعُ',
          },
          {
            masdar: 'التِّلَاوَةُ',
            masdarEn: 'recitation',
            ...
            present: 'يَتْلُو',
            imperative: 'اُتْلُ',
            prohibitive: 'لَا تَتْلُ',
          },
          {
            masdar: 'النَّجَاةُ',
            masdarEn: 'rescue / salvation',
            baab: 'ن',
            past: 'نَجَا',
            present: 'يَنْجُو',
            imperative: 'اُنْجُ',
            prohibitive: 'لَا تَنْجُ',
          },
          {
            masdar: 'السَّقْيُ',
            masdarEn: 'giving to drink',
            baab: 'ض',
            past: 'سَقَى',
            present: 'يَسْقِي',
            imperative: 'اِسْقِ',
            prohibitive: 'لَا تَسْقِ',
          },
          {
            masdar: 'الْبُكَاءُ',
            masdarEn: 'crying / weeping',
            baab: 'ض',
            past: 'بَكَى',
            present: 'يَبْكِي',
            imperative: 'اِبْكِ',
            prohibitive: 'لَا تَبْكِ',
          },
          {
            masdar: 'الْمَشْيُ',
            masdarEn: 'walking',
          ...
          },
          {
            ...
            present: 'يَرْمِي',
            imperative: 'اِرْمِ',
            prohibitive: 'لَا تَرْمِ',
          },
          {
            masdar: 'الرِّضْوَانُ',
            masdarEn: 'being pleased',
            baab: 'س',
            past: 'رَضِيَ',
            present: 'يَرْضَى',
            imperative: 'اِرْضَ',
            prohibitive: 'لَا تَرْضَ',
          },
          {
            masdar: 'النِّسْيَانُ',
            masdarEn: 'forgetting',
          ...
          },
          {
            ...
            present: 'يَبْقَى',
            imperative: 'اِبْقَ',
            prohibitive: 'لَا تَبْقَ',
          },
          {
            masdar: 'السَّعْيُ',
            masdarEn: 'striving / trying',
            baab: 'ف',
            past: 'سَعَى',
            present: 'يَسْعَى',
            imperative: 'اِسْعَ',
          ...
          },
          {
            ...
            present: 'يَرْعَى',
            imperative: 'اِرْعَ',
            prohibitive: 'لَا تَرْعَ',
          },
          {
            masdar: 'الْبِنَاءُ',
            masdarEn: 'building / constructing',
            baab: 'ض',
            past: 'بَنَى',
            present: 'يَبْنِي',
            imperative: 'اِبْنِ',
            prohibitive: 'لَا تَبْنِ',
          },
        ],
      },
    },
        ...
        rules: [
          {
            ...
            meaning:
              "أَيُّ is used with masculine nouns and أَيَّةُ with feminine nouns to mean 'which'.",
            examples: [
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'Allah calls you to Paradise and Satan calls you to the Fire. The Messenger of Allah (peace be upon him) called us to goodness. O human! Do not call upon anyone alongside Allah.',
          },
          {
            ...
            translationEn:
              'The small child was not able to walk, so he would walk and fall, then get up and walk and fall — this is how he learned to walk. Who taught the small child to walk? Allah taught him.',
          },
          {
            ...
            translationEn:
              'The scholar said in his sermon: "The Resurrection will come and the world will perish. Everything will perish — the earth will perish and the sky will perish. Nothing will remain except the Face of your Lord. Then Allah will gather His servants in the assembly and hold them accountable and recompense them."',
          },
          {
            ...
            translationEn:
              'Allah forbade us from wine and gambling and said: "In them is great sin." Indeed, prayer forbids indecency and evil. Allah was pleased with the Companions for their deeds.',
          },
        ],
      },
    },
      ...
      payload: {
        ...
        questions: [
          ...
          },
          {
            ...
            options_ar: ['اللهُ عَلَّمَهُ', 'أُمُّهُ عَلَّمَتْهُ', 'أَبُوهُ عَلَّمَهُ'],
            questionType: 'general',
          },
          {
            emoji: '🌙',
      ...
      payload: {
        ...
        questions: [
          ...
          },
          {
            ...
            options_ar: ['May Allah heal you.', 'May Allah guide you.', 'May Allah protect you.'],
          },
          {
            emoji: '🤲',
