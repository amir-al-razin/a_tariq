    ...
    chunks: [
        {
            ...
            payload: {
                ...
                instruction: 'Each masdar is listed with its verb chapter (ف = فَتَحَ, ن = نَصَرَ, ض = ضَرَبَ)',
                masdarRows: [
                    { masdar: 'الْمَلْأُ', masdarEn: 'to fill', baab: 'ف', past: 'مَلَأَ', present: 'يَمْلَأُ', imperative: 'اِمْلَأْ', prohibitive: 'لَا تَمْلَأْ' },
                    { masdar: 'الذِّكْرُ', masdarEn: 'to remember / mention', baab: 'ن', past: 'ذَكَرَ', present: 'يَذْكُرُ', imperative: 'اُذْكُرْ', prohibitive: 'لَا تَذْكُرْ' },
                    { masdar: 'الْحَمْلُ', masdarEn: 'to carry', baab: 'ض', past: 'حَمَلَ', present: 'يَحْمِلُ', imperative: 'اِحْمِلْ', prohibitive: 'لَا تَحْمِلْ' },
                    { masdar: 'الْإِذْنُ', masdarEn: 'to permit / give permission', baab: 'س', past: 'أَذِنَ', present: 'يَأْذَنُ', imperative: 'اِئْذَنْ', prohibitive: 'لَا تَأْذَنْ' },
                    { masdar: 'الطَّرْدُ', masdarEn: 'to drive away / expel', baab: 'ن', past: 'طَرَدَ', present: 'يَطْرُدُ', imperative: 'اُطْرُدْ', prohibitive: 'لَا تَطْرُدْ' },
                    { masdar: 'الْكَنْسُ', masdarEn: 'to sweep', baab: 'ن', past: 'كَنَسَ', present: 'يَكْنُسُ', imperative: 'اُكْنُسْ', prohibitive: 'لَا تَكْنُسْ' },
                    { masdar: 'الصُّنْعُ', masdarEn: 'to make / manufacture', baab: 'ف', past: 'صَنَعَ', present: 'يَصْنَعُ', imperative: 'اِصْنَعْ', prohibitive: 'لَا تَصْنَعْ' },
                    { masdar: 'الْكَسْرُ', masdarEn: 'to break', baab: 'ض', past: 'كَسَرَ', present: 'يَكْسِرُ', imperative: 'اِكْسِرْ', prohibitive: 'لَا تَكْسِرْ' },
                    { masdar: 'الْكَسْبُ', masdarEn: 'to earn', baab: 'ض', past: 'كَسَبَ', present: 'يَكْسِبُ', imperative: 'اِكْسِبْ', prohibitive: 'لَا تَكْسِبْ' },
                    { masdar: 'الْعَوْذُ', masdarEn: 'to seek refuge', baab: 'ن', past: 'عَاذَ', present: 'يَعُوذُ', imperative: 'عُذْ', prohibitive: 'لَا تَعُذْ' },
                ],
            },
        },
        {
            ...
            payload: {
                words: [
                    ...
                    { id: 5, ar: 'مَائِدَةُ الطَّعَامِ', romanized: "māʾidatu ṭ-ṭa'ām", en: 'Dining table', emoji: '🍽️' },
                    { id: 6, ar: 'الِامْتِحَانُ', romanized: 'al-imtiḥān', en: 'Examination / Test', emoji: '📝' },
                    { id: 7, ar: 'لَحْظَةٌ', romanized: 'laḥẓatun', en: 'A moment', emoji: '⏱️' },
                    { id: 8, ar: 'ذَاكِرٌ', romanized: 'dhākirun', en: 'One who remembers (Allah)', emoji: '🤲' },
                    ...
                    { id: 21, ar: 'مُخٌّ / لُبٌّ', romanized: 'mukhkh / lubb', en: 'Brain / Core', emoji: '🧠' },
                ],
            },
        },
        {
                ...
                rules: [
                    {
                        ...
                        meaning: 'The verb غَفَرَ (to forgive) requires لَـ before the pronoun, not a direct object.',
                        examples: [
            ...
            payload: {
                paragraphs: [
                    ...
                    },
                    {
                        ...
                        translationEn: 'O seeker of knowledge! Fill your heart with the light of knowledge. I filled the pen with ink and wrote a sentence on the paper. The dust of the grave fills the belly of man, and nothing else fills it. O Allah, fill my heart with the light of faith.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        translationEn: 'O Muslim! Remember Allah always and do not leave the remembrance of Allah for a moment, for indeed the heart of the heedless is dead, and indeed the heart of the rememberer is alive.',
                    },
                ],
            },
        },
