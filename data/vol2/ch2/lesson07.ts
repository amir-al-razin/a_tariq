  ...
  chunks: [
        ...
        words: [
          {
            ...
            ar: 'التَّفْكِيرُ',
            romanized: 'at-tafkīr',
            en: 'Thinking / Pondering',
            emoji: '🤔',
          },
          {
            id: 2,
            ar: 'التَّحْدِيثُ',
            romanized: 'at-taḥdīth',
            en: 'Speaking / Discussing',
            emoji: '🗣️',
          },
          { id: 3, ar: 'التَّطْهِيرُ', romanized: 'at-taṭhīr', en: 'Purifying', emoji: '✨' },
          {
            id: 4,
            ar: 'التَّعْذِيبُ',
            romanized: "at-ta'dhīb",
            en: 'Punishing / Torturing',
            emoji: '⚠️',
          },
          ...
          { id: 7, ar: 'السِّنُّ', romanized: 'as-sinnu', en: 'Tooth / Age', emoji: '🦷' },
          {
            id: 8,
            ar: 'التَّحَدُّثُ',
            romanized: 'at-taḥadduth',
            en: 'Conversing / Talking',
            emoji: '💬',
          },
          {
            id: 9,
            ar: 'التَّفَكُّرُ',
            romanized: 'at-tafakkur',
          ...
          },
          {
            id: 15,
            ar: 'التَّغْذِيَةُ',
            romanized: 'at-taghdhiyatu',
            en: 'Nourishing / Feeding',
            emoji: '🍽️',
          },
          {
            id: 16,
            ar: 'الرِّيَاضَةُ الْبَدَنِيَّةُ',
            romanized: 'ar-riyāḍatu l-badaniyyatu',
          ...
          { id: 17, ar: 'حَيٌّ', romanized: 'ḥayyun', en: 'Neighborhood', emoji: '🏘️' },
          {
            ...
            ar: 'الصُّعُودُ',
            romanized: "aṣ-ṣu'ūdu",
            en: 'Ascending / Climbing',
            emoji: '⬆️',
          },
          {
            id: 19,
            ar: 'الْخُطْبَةُ',
            romanized: 'al-khuṭbatu',
            en: 'Sermon / Speech',
            emoji: '📢',
          },
        ],
    ...
    },
    {
      ...
      payload: {
        ...
        instruction:
          "Naqis verbs in Bab At-Taf\'il have masdar pattern تَفْعِلَة instead of تَفْعِيل",
        masdarRows: [
          {
            masdar: 'التَّسْمِيَةُ',
            masdarEn: 'naming',
            past: 'سَمَّى',
            present: 'يُسَمِّي',
            imperative: 'سَمِّ',
            prohibitive: 'لَا تُسَمِّ',
          },
          {
            masdar: 'التَّقْوِيَةُ',
            masdarEn: 'strengthening',
            past: 'قَوَّى',
            present: 'يُقَوِّي',
            imperative: 'قَوِّ',
            prohibitive: 'لَا تُقَوِّ',
          },
          {
            masdar: 'التَّلْبِيَةُ',
            masdarEn: 'saying Labbayk',
            past: 'لَبَّى',
            present: 'يُلَبِّي',
            imperative: 'لَبِّ',
            prohibitive: 'لَا تُلَبِّ',
          },
          {
            masdar: 'التَّغْذِيَةُ',
            masdarEn: 'nourishing',
            past: 'غَذَّى',
            present: 'يُغَذِّي',
            imperative: 'غَذِّ',
            prohibitive: 'لَا تُغَذِّ',
          },
        ],
      },
    },
        ...
        rules: [
          {
            ...
            meaning:
              "Bab At-Taf\'il verbs are transitive/causative (acting on something else). Bab At-Tafa\'ul verbs are reflexive/intransitive (the subject acts on itself).",
            examples: [
              {
                ar: 'زَيَّنَ الْمَلِكُ الْمَدِينَةَ بِالْأَنْوَارِ',
                en: 'The king decorated the city with lights.',
              },
              {
                ar: 'تَزَيَّنَتِ الْمَدِينَةُ بِالْأَنْوَارِ',
                en: 'The city decorated itself with lights.',
              },
              ...
              {
                ar: 'تَعَلَّمَ الْوَلَدُ مِنْ أَبِيهِ الصَّلَاةَ',
                en: 'The boy learned the prayer from his father.',
              },
            ],
          },
        ],
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'The teacher said to his student: "Adorn yourself with knowledge before you adorn yourself with clothing, for the adornment of knowledge is better than the adornment of clothing."',
          },
          {
            ...
            translationEn:
              'Rashid prayed Dhuhr in the school mosque. Mahmud said: "I want to go now to the neighborhood mosque to pray Asr with the congregation. I love to always pray in the mosque with the congregation, because I know that congregational prayer is better than praying at home."',
          },
          {
            ...
            translationEn:
              'The Imam ascended the pulpit and delivered a sermon to the people. Then he descended and stood at the prayer area and led the people in prayer. When the Messenger of Allah (peace be upon him) fell ill, he commanded Abu Bakr (may Allah be pleased with him) to lead the people in prayer in the mosque.',
          },
        ],
      },
    },
      ...
      payload: {
        ...
        questions: [
          ...
          },
          {
            ...
            options_ar: ['تَحَدَّثْتُ مَعَهُ', 'حَدَّثَنِي', 'يُحَدِّثُنِي'],
          },
        ],
      },
    },
