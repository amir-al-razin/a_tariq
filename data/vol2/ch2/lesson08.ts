  ...
  chunks: [
      ...
      payload: {
        words: [
          ...
          },
          {
            id: 2,
            ar: 'الِانْتِقَالُ',
            romanized: 'al-intiqāl',
            en: 'To move (oneself) / pass away',
            emoji: '🚶',
          },
          ...
          },
          {
            ...
            romanized: 'aṣfaru / ṣafrāʾu',
            en: 'Yellow (m/f)',
            emoji: '🟡',
          },
          {
            id: 14,
            ar: 'حَمَامٌ / حَمَامَةٌ',
            romanized: 'ḥamāmun / ḥamāmatun',
            en: 'Pigeon / Dove',
            emoji: '🕊️',
          },
          {
    ...
    },
    {
      ...
      payload: {
        ...
        masdarRows: [
          {
            masdar: 'الِاشْتِرَاءُ',
            masdarEn: 'to buy / purchase',
            past: 'اِشْتَرَى',
            present: 'يَشْتَرِي',
            imperative: 'اِشْتَرِ',
            prohibitive: 'لَا تَشْتَرِ',
          },
          {
            masdar: 'الِاخْتِفَاءُ',
            masdarEn: 'to hide / conceal oneself',
            past: 'اِخْتَفَى',
            present: 'يَخْتَفِي',
            imperative: 'اِخْتَفِ',
            prohibitive: 'لَا تَخْتَفِ',
          },
          {
            masdar: 'الِانْتِهَاءُ',
            masdarEn: 'to end / finish',
            past: 'اِنْتَهَى',
            present: 'يَنْتَهِي',
            imperative: 'اِنْتَهِ',
            prohibitive: 'لَا تَنْتَهِ',
          },
          {
            masdar: 'الِارْتِوَاءُ',
            masdarEn: 'to be quenched (by drinking)',
            past: 'اِرْتَوَى',
            present: 'يَرْتَوِي',
            imperative: 'اِرْتَوِ',
            prohibitive: 'لَا تَرْتَوِ',
          },
          {
            masdar: 'الِاسْتِوَاءُ',
            masdarEn: 'to be equal / level',
            past: 'اِسْتَوَى',
            present: 'يَسْتَوِي',
            imperative: 'اِسْتَوِ',
            prohibitive: 'لَا تَسْتَوِ',
          },
        ],
      },
    },
        ...
        rules: [
          {
            ...
            romanized: 'aḥmaru / ḥamrāʾu',
            meaning:
              'Color adjectives follow the pattern أَفْعَلُ (m) and فَعْلَاءُ (f). They are diptotes: no tanween, and take fathah instead of kasrah in the genitive state.',
            examples: [
              { ar: 'جَاءَتْ عَائِشَةُ', en: 'Aisha came. (nominative)' },
              { ar: 'دَعَوْتُ عَائِشَةَ', en: 'I called Aisha. (accusative)' },
              {
                ar: 'سَلَّمْتُ عَلَى عَائِشَةَ',
                en: 'I greeted Aisha. (genitive — takes fathah, not kasrah)',
              },
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'O my Muslim brother! Your Lord has bought from you your soul and your wealth in exchange for Paradise. So fight in the path of Allah so that you may enter Paradise.',
          },
          {
            ...
            translationEn:
              'The scholar said in his sermon: "This life will end one day." A person moves to the next world after this life ends. Majid\'s father passed away to the mercy of Allah this evening.',
          },
          {
            ...
            translationEn:
              'The light of the sun hid behind the cloud. During the Hijra, the Messenger of Allah (peace be upon him) entered the Cave of Thawr to hide from the eyes of Quraysh.',
          },
        ],
      },
    },
