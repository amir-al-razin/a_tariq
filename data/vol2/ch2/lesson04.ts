      ...
      payload: {
        words: [
          ...
          { id: 13, ar: 'لَا تَقُولِي', romanized: 'lā taqūlī', en: "Don't say! (f)", emoji: '🚫' },
          {
            ...
            ar: 'بِمَ',
            romanized: 'bima',
            en: 'With what? (short for بِمَاذَا)',
            emoji: '❓',
          },
        ...
        rules: [
          {
            ...
            meaning:
              'The noun receiving the action of a transitive verb takes a fathah or fathatain (mansub state).',
            examples: [
          ...
          },
          {
            ...
            meaning:
              'When answering a negative question: بَلَى affirms the positive (Yes, I DO), while نَعَمْ agrees with the negative (Yes, I do NOT).',
            examples: [
              {
                ar: 'أَلَا تَفْهَمُ كَلَامَ اللهِ ؟ بَلَى، أَفْهَمُ',
                en: 'Do you not understand the words of Allah? Yes, I DO understand.',
              },
              {
                ar: 'أَلَا تَفْهَمُ كَلَامَ اللهِ ؟ نَعَمْ، لَا أَفْهَمُ',
                en: 'Do you not understand the words of Allah? Yes, I do NOT understand.',
              },
            ],
          },
        ],
      ...
      payload: {
        paragraphs: [
          ...
          },
          {
            ...
            translationEn:
              'Rashid asked Fatima: "O Fatima, do you know the Arabic language and understand the Book of Allah?" Fatima said: "Yes, I know the Arabic language and I understand the Book of Allah." Rashid said: "I understand the words of Allah because I know the Arabic language."',
          },
          {
            ...
            translationEn:
              'The polytheist does not know his Lord. How can the polytheist know his Lord when there is darkness in his heart! The Muslim drinks honey and does not drink wine, because it is forbidden. Allah supports His religion with a fly and with a mosquito.',
          },
        ],
      },
    },
