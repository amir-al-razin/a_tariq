    ...
    chunks: [
        {
            ...
            payload: {
                ...
                masdarRows: [
                    { masdar: 'السَّوْقُ', masdarEn: 'to pull / drive / steer', baab: 'ن', past: 'سَاقَ', present: 'يَسُوقُ', imperative: 'سُقْ', prohibitive: 'لَا تَسُقْ' },
                    ...
                    { masdar: 'الضَّيَاعُ', masdarEn: 'to be ruined / lost', baab: 'ض', past: 'ضَاعَ', present: 'يَضِيعُ', imperative: 'ضِعْ', prohibitive: 'لَا تَضِعْ' },
                    ...
                    { masdar: 'الْحُزْنُ', masdarEn: 'to be sad / grieve', baab: 'س', past: 'حَزِنَ', present: 'يَحْزَنُ', imperative: 'اِحْزَنْ', prohibitive: 'لَا تَحْزَنْ' },
                    { masdar: 'الْفَرَحُ', masdarEn: 'to be happy / rejoice', baab: 'س', past: 'فَرِحَ', present: 'يَفْرَحُ', imperative: 'اِفْرَحْ', prohibitive: 'لَا تَفْرَحْ' },
                    { masdar: 'الْعَيْشُ', masdarEn: 'to live', baab: 'ض', past: 'عَاشَ', present: 'يَعِيشُ', imperative: 'عِشْ', prohibitive: 'لَا تَعِشْ' },
                    { masdar: 'الْحَبْسُ', masdarEn: 'to confine / imprison', baab: 'ض', past: 'حَبَسَ', present: 'يَحْبِسُ', imperative: 'اِحْبِسْ', prohibitive: 'لَا تَحْبِسْ' },
                    { masdar: 'الْهَلَاكُ', masdarEn: 'to perish / be destroyed', baab: 'ض', past: 'هَلَكَ', present: 'يَهْلِكُ', imperative: 'اِهْلِكْ', prohibitive: 'لَا تَهْلِكْ' },
                ],
            },
        },
        {
                ...
                rules: [
                    {
                        ...
                        meaning: 'When a full sentence follows an indefinite noun (nakirah), the entire sentence functions as an adjective (sifah) describing that noun.',
                        examples: [
                            { ar: 'جَاءَنِي رَجُلٌ يَعْرِفُ اللُّغَةَ الْعَرَبِيَّةَ', en: 'A man who knows the Arabic language came to me.' },
                            { ar: 'هَذَا عَمَلٌ لَا يُضِيعُ أَجْرَهُ إِنْ شَاءَ اللهُ', en: 'This is a deed whose reward will not be lost, God willing.' },
                            { ar: 'أَلْبَسَ ثَوْبًا لَوْنُهُ جَمِيلٌ', en: 'He is wearing a garment whose color is beautiful.' },
                            { ar: 'اِقْرَأْ كِتَابًا يَنْفَعُكَ فِي دِينِكَ', en: 'Read a book that benefits you in your religion.' },
                        ],
                    },
                ],
            },
            ...
            payload: {
                paragraphs: [
                    ...
                    },
                    {
                        ...
                        translationEn: 'Greed drives a person to death. Sugar melts in water, but stone does not melt. Majid\'s grandfather lived for a hundred years then died. Humans live on land and fish live in water.',
                    },
                    {
