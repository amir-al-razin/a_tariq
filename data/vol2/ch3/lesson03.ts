  ...
  chunks: [
      ...
      payload: {
        words: [
          ...
          },
          {
            ...
            en: 'Bigger / older than',
            emoji: '📏',
          },
          {
            id: 11,
            ar: 'أَصْغَرُ مِنْ',
            romanized: 'aṣgharu min',
            en: 'Smaller / younger than',
            emoji: '📏',
          },
        ...
        rules: [
          {
            ...
            meaning:
              'Nouns and adjectives are made dual by adding the suffix ـَانِ (aan) to the singular form. The dual pronouns are هُمَا (they two), أَنْتُمَا (you two), and نَحْنُ (we two).',
            examples: [
              {
                ar: 'رَاشِدٌ وَخَالِدٌ تِلْمِيذَانِ ذَكِيَّانِ',
                en: 'Rashid and Khalid are two smart students.',
              },
              {
                ar: 'فَاطِمَةُ وَعَائِشَةُ تِلْمِيذَتَانِ ذَكِيَّتَانِ',
                en: 'Fatima and Aisha are two smart female students.',
              },
          ...
          },
          {
            ...
            meaning:
              'هَؤُلَاءِ (These) and أُولَئِكَ (Those) are used with plural human nouns. Non-human plurals are treated as feminine singular.',
            examples: [
              { ar: 'هَؤُلَاءِ الْأَوْلَادُ صَادِقُونَ', en: 'These boys are truthful.' },
              { ar: 'أُولَئِكَ الرِّجَالُ كَاذِبُونَ', en: 'Those men are liars.' },
              {
                ar: 'هَذِهِ الْكُتُبُ جَدِيدَةٌ',
                en: 'These books are new. (non-human plural = feminine singular)',
              },
            ],
          },
          {
            ...
            romanized: 'akbaru min',
            meaning:
              "The comparative adjective is formed on the pattern أَفْعَلُ (Af'alu), often followed by مِنْ (than).",
            examples: [
              { ar: 'خَالِدٌ أَكْبَرُ مِنْ رَاشِدٍ', en: 'Khalid is older than Rashid.' },
              { ar: 'اللهُ أَكْبَرُ', en: 'Allah is the Greatest.' },
              {
                ar: 'سُوقُ الْقَرْيَةِ أَصْغَرُ مِنْ سُوقِ الْمَدِينَةِ',
                en: 'The village market is smaller than the city market.',
              },
            ],
          },
          {
            ...
            meaning:
              "Using لَا followed by a noun ending in a single fathah means 'Absolutely no...' (negation of the entire category).",
            examples: [
              { ar: 'لَا شَكَّ فِي كَلَامِكَ', en: 'There is no doubt in your speech.' },
              {
                ar: 'لَا نُورَ فِي قَلْبِ الْمُنَافِقِ',
                en: "There is no light in the hypocrite\'s heart.",
              },
    ...
    },
    {
      ...
      payload: {
        ...
        instruction:
          'The particle أَنْ followed by a present tense verb acts as a verbal noun (masdar)',
        masdarRows: [
          {
            masdar: 'أَنْ تَصُومَ',
            masdarEn: 'to fast / your fasting',
            past: 'صَامَ',
            present: 'يَصُومُ',
            imperative: 'صُمْ',
            prohibitive: 'لَا تَصُمْ',
          },
          {
            masdar: 'أَنْ تَسْعَى',
            masdarEn: 'to strive / your striving',
            past: 'سَعَى',
            present: 'يَسْعَى',
            imperative: 'اِسْعَ',
            prohibitive: 'لَا تَسْعَ',
          },
          {
            masdar: 'أَنْ تَعْمَلَ',
            masdarEn: 'to work / your working',
            past: 'عَمِلَ',
            present: 'يَعْمَلُ',
            imperative: 'اِعْمَلْ',
            prohibitive: 'لَا تَعْمَلْ',
          },
        ],
      },
    },
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'Rashid and Khalid are two smart students — they are two smart students. Fatima and Aisha are two smart female students — they are two smart female students. You and I are two male teachers — we are two skilled male teachers.',
          },
          {
            ...
            translationEn:
              'The book is new — the two books are new — the books are new. The mosque is beautiful — the two mosques are beautiful — the mosques are beautiful. The boy is hardworking — the two boys are hardworking — the boys are hardworking. The girl is hardworking — the two girls are hardworking — the girls are hardworking.',
          },
          {
            ...
            translationEn:
              'Khalid is older than Rashid — Fatima is older than Aisha — Allah is the Greatest. This medicine is beneficial and that medicine is more beneficial than it. The village market is smaller than the city market. I am taller than you and you are shorter than me.',
          },
          {
            ...
            translationEn:
              "There is no doubt in your speech — that book, there is no doubt in it. There is no light in the hypocrite's heart — there is no blessing in the miser's wealth. The Messenger of Allah (peace be upon him) said: 'There is no prophet after me.'",
          },
          {
            ...
            translationEn:
              'To fast is better for you — your fasting is better for you. To strive is better for you — your striving is better for you. To work is better for you — your working is better for you. Your striving and diligence open the door of happiness for you. Your laziness and sitting back from work will ruin your future.',
          },
        ],
      },
    },
        ...
        questions: [
          {
            ...
            options_ar: ['رَاشِدٌ وَخَالِدٌ', 'فَاطِمَةُ وَعَائِشَةُ', 'مَاجِدٌ وَبِلَالٌ'],
          ...
          },
          {
            ...
            options_ar: ['سَعْيُكَ وَاجْتِهَادُكَ', 'كَسَلُكَ وَقُعُودُكَ', 'مَالُكَ وَثَرْوَتُكَ'],
            questionType: 'general',
          },
        ],
      },
