        ...
        rules: [
          {
            ...
            meaning:
              'The verb سَالَ (to flow) is used with مِنْ to indicate the source of the flow.',
            examples: [
          ...
          },
          {
            ...
            meaning:
              'When a complete sentence follows an indefinite noun, the sentence functions as an adjective for that noun.',
            examples: [
              {
              ...
              {
                ar: 'هَذَا عَمَلٌ لَا يَضِيعُ أَجْرُهُ',
                en: 'This is a deed whose reward will not be lost.',
              },
              {
                ar: 'اقْرَأْ كِتَابًا يَنْفَعُكَ فِي دِينِكَ',
      ...
      payload: {
        paragraphs: [
          ...
          },
          {
            ...
            translationEn:
              'Sweat flows from the body of this farmer, because he worked under the sun and got tired from the work. So he sat under the shade of a tree to rest a little. The brave warrior said: "I will never melt (surrender) in front of falsehood."',
          },
        ],
      },
    },
      ...
      payload: {
        ...
        questions: [
          ...
          },
          {
            ...
            options_ar: ['جَاءَنِي أَمْسِ', 'جَاءَنِي الْيَوْمَ', 'لَمْ يَجِئْنِي بَعْدُ'],
            questionType: 'general',
          },
          {
            emoji: '🦁',
        ...
        questions: [
          {
            ...
            options_ar: ['He will not come.', 'He came.', 'Come! (command)'],
          },
          {
            emoji: '🏆',
