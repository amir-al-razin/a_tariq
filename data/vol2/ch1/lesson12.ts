    ...
    chunks: [
        {
            ...
            payload: {
                words: [
                    ...
                    { id: 2, ar: 'مُعَلِّمٌ / مُعَلِّمَةٌ', romanized: "mu'allim / mu'allimah", en: 'Teacher (m/f)', emoji: '👨‍🏫' },
                    ...
                    { id: 11, ar: 'كَسْلَانٌ / كَسْلَانَةٌ', romanized: 'kaslān / kaslānah', en: 'Lazy (m/f)', emoji: '😴' },
                    { id: 12, ar: 'نَشِيطٌ / نَشِيطَةٌ', romanized: 'nashīṭ / nashīṭah', en: 'Active / Energetic (m/f)', emoji: '⚡' },
        ...
        },
        {
            ...
            payload: {
                verbTense: 'past',
                instruction: 'These three verbs put their predicate (خبر) into the accusative (fathatayn). لَيْسَ is present-meaning despite past form.',
                verbTable: [
                    { root: 'كَانَ', meaning: 'was', he: 'كَانَ', she: 'كَانَتْ', youM: 'كُنْتَ', youF: 'كُنْتِ', i: 'كُنْتُ' },
                    { root: 'صَارَ', meaning: 'became', he: 'صَارَ', she: 'صَارَتْ', youM: 'صِرْتَ', youF: 'صِرْتِ', i: 'صِرْتُ' },
                    { root: 'لَيْسَ', meaning: 'is not', he: 'لَيْسَ', she: 'لَيْسَتْ', youM: 'لَسْتَ', youF: 'لَسْتِ', i: 'لَسْتُ' },
                ],
            },
        },
        {
                ...
                paragraphs: [
                    {
                        ...
                        translationEn: 'Rashid is a student. / Rashid was a student. / Rashid became a teacher. / Rashid is not a student. Fatima is young. / Fatima was young. / Fatima became old. / Fatima is not young.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: 'You are a poor man. / You were a poor man. / You became a rich man. / You are not a poor man. I am a farmer. / I was a farmer. / I became a merchant. / I am not a farmer.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: 'The door was open. / The door became closed. / The door is not open. The madrasa was small. / The madrasa became big. / The madrasa is not small. You were a sinner. / You became righteous. / You are not a sinner.',
                    },
                ],
            },
        },
                ...
                rules: [
                    {
                        ...
                        meaning: 'Adding بِـ to the predicate of لَيْسَ creates emphatic negation. The predicate takes kasratayn instead of fathatayn.',
                        examples: [
                            { ar: 'لَيْسَ رَاشِدٌ كَاذِبًا ← لَيْسَ رَاشِدٌ بِكَاذِبٍ', en: 'Rashid is not a liar (emphatic)' },
                            { ar: 'لَسْتَ صَادِقًا ← لَسْتَ بِصَادِقٍ', en: 'You are not truthful (emphatic)' },
                            { ar: 'لَسْتُ مُنَافِقًا ← لَسْتُ بِمُنَافِقٍ', en: 'I am not a hypocrite (emphatic)' },
