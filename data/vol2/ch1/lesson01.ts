        ...
        paragraphs: [
          {
            ...
            translationEn:
              'Rashid exited his house and went to the madrasa and sat in front of the teacher. Rashid read and wrote in the madrasa, then returned home and played in the village playground. Rashid played with Khalid with a new ball.',
          },
          {
            lines: [
            ...
            translationEn:
              "Rashid's sister exited her room and went to the madrasa and sat in front of the female teacher. She read and wrote in the madrasa, then returned home and played in Aisha's garden.",
          },
        ],
      },
    },
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'Khalid is now exiting his house and going to the madrasa and sitting in front of the teacher. Khalid reads and writes in the classroom then returns home. He returns before Asr and plays in the village playground after Asr.',
          },
          {
            lines: [
            ...
            translationEn:
              "Fatima is now exiting her room and going to the house garden and playing with Zainab. After Maghrib, Fatima sits in her room and reads and writes. Su'ad's mother returns tomorrow from the village house.",
          },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '🏃',
            question_ar: 'مِنْ أَيْنَ خَرَجَ رَاشِدٌ ؟',
            question_en: 'Where did Rashid exit from?',
            correct_ar: 'خَرَجَ مِنْ بَيْتِهِ',
            correct_en: 'He exited from his house.',
            options_ar: [
              'خَرَجَ مِنْ بَيْتِهِ',
              'خَرَجَ مِنَ الْمَدْرَسَةِ',
              'خَرَجَ مِنَ الْمَسْجِدِ',
            ],
            questionType: 'general',
          },
          {
            emoji: '🏫',
            question_ar: 'إِلَى أَيْنَ ذَهَبَ رَاشِدٌ ؟',
            question_en: 'Where did Rashid go?',
            correct_ar: 'ذَهَبَ إِلَى الْمَدْرَسَةِ',
            correct_en: 'He went to the madrasa.',
            options_ar: [
              'ذَهَبَ إِلَى الْمَدْرَسَةِ',
              'ذَهَبَ إِلَى السُّوقِ',
              'ذَهَبَ إِلَى الْمَلْعَبِ',
            ],
            questionType: 'general',
          },
          {
            emoji: '📖',
            question_ar: 'مَاذَا فَعَلَ رَاشِدٌ فِي الْمَدْرَسَةِ ؟',
            question_en: 'What did Rashid do in the madrasa?',
            correct_ar: 'قَرَأَ وَكَتَبَ',
            correct_en: 'He read and wrote.',
            options_ar: ['قَرَأَ وَكَتَبَ', 'لَعِبَ وَجَلَسَ', 'رَجَعَ وَخَرَجَ'],
            questionType: 'general',
          },
          {
            emoji: '⚽',
            question_ar: 'أَيْنَ لَعِبَ رَاشِدٌ ؟',
            question_en: 'Where did Rashid play?',
            correct_ar: 'لَعِبَ فِي مَلْعَبِ الْقَرْيَةِ',
            correct_en: 'He played in the village playground.',
            options_ar: [
              'لَعِبَ فِي مَلْعَبِ الْقَرْيَةِ',
              'لَعِبَ فِي الْحَدِيقَةِ',
              'لَعِبَ فِي الطَّرِيقِ',
            ],
            questionType: 'general',
          },
          {
            emoji: '🕐',
            question_ar: 'مَتَى يَرْجِعُ خَالِدٌ إِلَى الْبَيْتِ ؟',
            question_en: 'When does Khalid return home?',
            correct_ar: 'يَرْجِعُ قَبْلَ الْعَصْرِ',
            correct_en: 'He returns before Asr.',
            options_ar: [
              'يَرْجِعُ قَبْلَ الْعَصْرِ',
              'يَرْجِعُ بَعْدَ الْعَصْرِ',
              'يَرْجِعُ صَبَاحًا',
            ],
            questionType: 'general',
          },
          {
            ...
            correct_ar: 'تَجْلِسُ فِي غُرْفَتِهَا وَتَقْرَأُ وَتَكْتُبُ',
            correct_en: 'She sits in her room and reads and writes.',
            options_ar: [
              'تَجْلِسُ فِي غُرْفَتِهَا وَتَقْرَأُ وَتَكْتُبُ',
              'تَذْهَبُ إِلَى الْحَدِيقَةِ',
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '🏫',
            question_ar: 'ذَهَبَ التِّلْمِيذُ ___ الْمُعَلِّمِ',
            question_en: 'The student went ___ the teacher.',
            correct_ar: 'إِلَى',
            correct_en: 'to',
            options_ar: ['إِلَى', 'عِنْدَ', 'مِنْ'],
          },
          {
            emoji: '⚽',
            question_ar: 'أَنَا أَذْهَبُ ___ الْمَلْعَبِ',
            question_en: 'I go ___ the playground.',
            correct_ar: 'إِلَى',
            correct_en: 'to',
            options_ar: ['إِلَى', 'فِي', 'مَعَ'],
          },
          {
            emoji: '🪑',
            question_ar: 'اِجْلِسْ ___ الْأَرْضِ',
            question_en: 'Sit ___ the ground.',
            correct_ar: 'عَلَى',
            correct_en: 'on',
            options_ar: ['عَلَى', 'فِي', 'مِنْ'],
          },
          {
            emoji: '🕌',
            question_ar: 'أَنْتَ جَلَسْتَ ___ الْمَسْجِدِ',
            question_en: 'You sat ___ the mosque.',
            correct_ar: 'فِي',
            correct_en: 'in',
            options_ar: ['فِي', 'عَلَى', 'إِلَى'],
          },
          {
            emoji: '🖊️',
            question_ar: 'يَكْتُبُ الْمُعَلِّمُ ___ السَّبُّوْرَةِ',
            question_en: 'The teacher writes ___ the board.',
            correct_ar: 'عَلَى',
            correct_en: 'on',
            options_ar: ['عَلَى', 'فِي', 'بِـ'],
          },
        ],
      },
    },
