        ...
        rules: [
          {
            ...
            meaning:
              "When reporting speech, attach لَـ to the pronoun to indicate 'said to him/her/me'",
            examples: [
        ...
        rules: [
          {
            ...
            examples: [
              ...
              {
                ar: 'دَخَلَ الرَّجُلُ فِي دِينِ اللهِ',
                en: 'The man entered into the religion of Allah',
              },
      ...
      payload: {
        paragraphs: [
          ...
          },
          {
            ...
            translationEn:
              "Majid's father died a year ago and his mother died a month ago. Man dies one day and stands before Allah, and Allah will ask him about his life.",
          },
          {
            lines: [
            ...
            translationEn:
              'The Muslim fasts in the month of Ramadan. This is the month of Ramadan; I fasted today and will fast tomorrow. My sister does not fast because she is small.',
          },
          {
            lines: [
            ...
            translationEn:
              "Majid's uncle is a skilled hunter. He hunts in a distant forest. A week ago he hunted a beautiful deer.",
          },
          {
            lines: [
    ...
    },
    {
      ...
      payload: {
        questions: [
          {
            emoji: '😴',
            question_ar: 'أَقَبْلَ الْعِشَاءِ تَنَامُ أَمْ بَعْدَ الْعِشَاءِ؟',
            question_en: 'Do you sleep before Isha or after Isha?',
            correct_ar: 'بَلْ بَعْدَ الْعِشَاءِ',
            correct_en: 'Rather, after Isha.',
            options_ar: ['بَلْ بَعْدَ الْعِشَاءِ', 'قَبْلَ الْعِشَاءِ', 'لَا أَنَامُ'],
            questionType: 'a_am',
          },
          {
            emoji: '🧵',
            question_ar: 'مَنْ تَخِيطُ ثَوْبَهَا بِيَدِهَا؟',
            question_en: 'Who sews her dress with her hand?',
            correct_ar: 'زَيْنَبُ تَخِيطُ ثَوْبَهَا بِيَدِهَا',
            correct_en: 'Zainab sews her dress with her hand.',
            options_ar: [
              'زَيْنَبُ تَخِيطُ ثَوْبَهَا بِيَدِهَا',
              'فَاطِمَةُ تَخِيطُ ثَوْبَهَا',
              'الْأُمُّ تَخِيطُ',
            ],
          ...
          {
            emoji: '🦋',
            question_ar: 'مَاذَا تَفْعَلُ الْفَرَاشَةُ الْجَمِيلَةُ؟',
            question_en: 'What does the beautiful butterfly do?',
            correct_ar: 'تَطِيرُ مِنْ زَهْرَةٍ إِلَى زَهْرَةٍ',
            correct_en: 'It flies from flower to flower.',
            options_ar: [
              'تَطِيرُ مِنْ زَهْرَةٍ إِلَى زَهْرَةٍ',
              'تَجْلِسُ عَلَى الشَّجَرَةِ',
              'تَنَامُ فِي الْحَدِيقَةِ',
            ],
            questionType: 'general',
          },
          {
            emoji: '🌙',
            question_ar: 'هَلْ يَصُومُ الْمُسْلِمُ فِي رَمَضَانَ؟',
            question_en: 'Does the Muslim fast in Ramadan?',
            correct_ar: 'نَعَمْ .. يَصُومُ فِي شَهْرِ رَمَضَانَ',
            correct_en: 'Yes, he fasts in the month of Ramadan.',
            options_ar: [
              'نَعَمْ .. يَصُومُ فِي شَهْرِ رَمَضَانَ',
              'لَا .. لَا يَصُومُ',
              'يَصُومُ أَحْيَانًا',
            ],
            questionType: 'hal',
        ...
        questions: [
          {
            ...
            correct_ar: 'Say! (command)',
            correct_en: 'Say! (command)',
            options_ar: ['Say! (command)', 'He said', 'Do not say'],
          },
          {
            emoji: '😴',
            question_ar: 'لَا تَنَمْ',
            question_en: 'What does this mean?',
            correct_ar: 'Do not sleep! (command)',
            correct_en: 'Do not sleep! (command)',
            options_ar: ['Do not sleep! (command)', 'He did not sleep', 'She sleeps'],
          },
          {
            emoji: '🛒',
            question_ar: 'بِعْتُ',
            ...
            correct_ar: 'I sold',
            correct_en: 'I sold',
            options_ar: ['I sold', 'Sell! (command)', 'He sold'],
          },
          {
            emoji: '🤲',
            question_ar: 'مَا تَابَ',
            question_en: 'What does this mean?',
            correct_ar: 'He did not repent',
            correct_en: 'He did not repent',
            options_ar: ['He did not repent', 'He repented', 'Repent!'],
          },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '😨',
            question_ar: 'Do not fear! (m)',
            question_en: 'Do not fear! (m)',
            correct_ar: 'لَا تَخَفْ',
            correct_en: 'Do not fear!',
            options_ar: ['لَا تَخَفْ', 'لَا تَخَافُ', 'مَا خَافَ'],
          },
          {
            emoji: '🛒',
            question_ar: 'Do not sell! (m)',
            question_en: 'Do not sell! (m)',
            correct_ar: 'لَا تَبِعْ',
            correct_en: 'Do not sell!',
            options_ar: ['لَا تَبِعْ', 'لَا تَبِيعُ', 'مَا بَاعَ'],
          },
          {
            emoji: '🌙',
            question_ar: 'Fast! (m)',
