      ...
      payload: {
        ...
        masdarRows: [
          ...
          },
          {
            ...
            present: 'يَكْتُبُ',
            imperative: 'اُكْتُبْ',
            prohibitive: 'لَا تَكْتُبْ',
          },
          {
            masdar: 'الصِّدْقُ',
            masdarEn: 'to tell the truth',
            past: 'صَدَقَ',
            present: 'يَصْدُقُ',
            imperative: 'اُصْدُقْ',
      ...
      payload: {
        ...
        masdarRows: [
          ...
          },
          {
            ...
            present: 'يَضْحَكُ',
            imperative: 'اِضْحَكْ',
            prohibitive: 'لَا تَضْحَكْ',
          },
          {
            masdar: 'الْفَهْمُ',
            masdarEn: 'to understand',
            past: 'فَهِمَ',
            present: 'يَفْهَمُ',
            imperative: 'اِفْهَمْ',
            prohibitive: 'لَا تَفْهَمْ',
          },
        ],
      },
    },
      ...
      payload: {
        paragraphs: [
          ...
          },
          {
            ...
            translationEn:
              'O boy! Always tell the truth and never lie. The Muslim always tells the truth and never lies. The Messenger of Allah ﷺ never lied in his life. The fish swims in the river water. Rain descends from the sky. The lazy person does not succeed in his life.',
          },
        ],
      },
    },
    {
      ...
      payload: {
        questions: [
          {
            emoji: '📖',
            question_ar: 'عَلَى مَنْ نَزَلَ الْقُرْآنُ ؟',
            question_en: 'Upon whom was the Quran revealed?',
            correct_ar: 'نَزَلَ عَلَى رَسُولِ اللهِ ﷺ',
            correct_en: 'It was revealed upon the Messenger of Allah ﷺ.',
            options_ar: [
              'نَزَلَ عَلَى رَسُولِ اللهِ ﷺ',
              'نَزَلَ عَلَى مُوسَى',
              'نَزَلَ عَلَى إِبْرَاهِيمَ',
            ],
            questionType: 'general',
          },
          {
            emoji: '🌙',
            question_ar: 'مَتَى نَزَلَ الْقُرْآنُ ؟',
            question_en: 'When was the Quran revealed?',
            correct_ar: 'نَزَلَ فِي شَهْرِ رَمَضَانَ',
            correct_en: 'It was revealed in the month of Ramadan.',
            options_ar: [
              'نَزَلَ فِي شَهْرِ رَمَضَانَ',
              'نَزَلَ فِي شَهْرِ رَجَبٍ',
              'نَزَلَ فِي شَهْرِ شَعْبَانَ',
            ],
            questionType: 'general',
          },
          {
            emoji: '🍽️',
            question_ar: 'هَلْ يَأْكُلُ الصَّائِمُ فِي نَهَارِ رَمَضَانَ ؟',
            question_en: 'Does the fasting person eat during the daytime of Ramadan?',
            correct_ar: 'لَا .. لَا يَأْكُلُ وَلَا يَشْرَبُ',
            correct_en: 'No, he does not eat or drink.',
            options_ar: [
              'لَا .. لَا يَأْكُلُ وَلَا يَشْرَبُ',
              'نَعَمْ .. يَأْكُلُ',
              'نَعَمْ .. يَشْرَبُ فَقَطْ',
            ],
            questionType: 'hal',
          },
          {
            emoji: '🌧️',
            question_ar: 'مِنْ أَيْنَ يَنْزِلُ الْمَطَرُ ؟',
            question_en: 'Where does rain descend from?',
            correct_ar: 'يَنْزِلُ مِنَ السَّمَاءِ',
            correct_en: 'It descends from the sky.',
            options_ar: [
              'يَنْزِلُ مِنَ السَّمَاءِ',
              'يَنْزِلُ مِنَ الْجَبَلِ',
              'يَنْزِلُ مِنَ الْبَحْرِ',
            ],
            questionType: 'general',
          },
          {
            emoji: '😴',
            question_ar: 'هَلْ يَنْجَحُ الْكَسْلَانُ فِي حَيَاتِهِ ؟',
            question_en: 'Does the lazy person succeed in his life?',
            correct_ar: 'لَا .. لَا يَنْجَحُ',
            correct_en: 'No, he does not succeed.',
            options_ar: ['لَا .. لَا يَنْجَحُ', 'نَعَمْ .. يَنْجَحُ', 'أَحْيَانًا يَنْجَحُ'],
            questionType: 'hal',
          },
        ],
      },
