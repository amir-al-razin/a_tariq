        ...
        rules: [
          {
            ...
            meaning:
              "لَنْ + present tense verb (with fatha ending) = 'will definitely not do'. Stronger than لَا.",
            examples: [
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'The polytheist will definitely not enter Paradise. I will definitely not obey Satan, because I am a Muslim. The hypocrite will definitely not tell the truth, and the Muslim will definitely not lie. I will definitely not lie, because I am a Muslim. The Muslim will definitely not fear anyone other than Allah.',
          },
          {
            lines: [
    ...
    },
    {
      ...
      payload: {
        questions: [
          {
            emoji: '🚪',
            question_ar: 'يَا فَرْحَانَةُ! أَلَنْ تَدْخُلِي غُرْفَتَكِ الْآنَ؟',
            question_en: 'O Farhana! Will you definitely not enter your room now?',
            correct_ar: 'نَعَمْ .. لَنْ أَدْخُلَ الْآنَ غُرْفَتِي',
            correct_en: 'Yes, I will definitely not enter my room now.',
            options_ar: [
              'نَعَمْ .. لَنْ أَدْخُلَ الْآنَ غُرْفَتِي',
              'بَلَى .. سَأَدْخُلُ',
              'لَا أَعْرِفُ',
            ],
            questionType: 'hal',
          ...
          {
            emoji: '🍽️',
            question_ar: 'أَلَنْ تُطْعِمَ هَذَا الْجَائِعَ؟',
            question_en: 'Will you definitely not feed this hungry person?',
            correct_ar: 'بَلَى .. سَأُطْعِمُهُ',
            correct_en: 'On the contrary, I will feed him.',
            options_ar: ['بَلَى .. سَأُطْعِمُهُ', 'نَعَمْ .. لَنْ أُطْعِمَهُ', 'لَا أَسْتَطِيعُ'],
            questionType: 'hal',
          },
          {
            emoji: '✅',
            question_ar: 'يَا فَاطِمَةُ! أَلَنْ تُطِيعِي أَبَاكِ وَأُمَّكِ؟',
            question_en: 'O Fatima! Will you definitely not obey your father and mother?',
            correct_ar: 'بَلَى أُطِيعُهُمَا',
            correct_en: 'On the contrary, I will obey them both.',
            options_ar: [
              'بَلَى أُطِيعُهُمَا',
              'نَعَمْ .. لَنْ أُطِيعَهُمَا',
              'أُطِيعُ أَبِي فَقَطْ',
            ],
            questionType: 'hal',
          },
        ],
        ...
        rules: [
          {
            ...
            meaning:
              'When calling someone with a possessive title (Mudaf), the first word takes fatha (Mansub) after يَا',
            examples: [
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '📚',
            question_ar: 'مُعَلِّمُ الْمَدْرَسَةِ → يَا ___',
            question_en: 'Teacher of the school → O ___',
            correct_ar: 'يَا مُعَلِّمَ الْمَدْرَسَةِ',
            correct_en: 'O teacher of the school',
            options_ar: [
              'يَا مُعَلِّمَ الْمَدْرَسَةِ',
              'يَا مُعَلِّمُ الْمَدْرَسَةِ',
              'يَا مُعَلِّمٍ الْمَدْرَسَةِ',
            ],
          },
          {
            emoji: '🕌',
            question_ar: 'إِمَامُ الْمَسْجِدِ → يَا ___',
            question_en: 'Imam of the mosque → O ___',
            correct_ar: 'يَا إِمَامَ الْمَسْجِدِ',
            correct_en: 'O Imam of the mosque',
            options_ar: [
              'يَا إِمَامَ الْمَسْجِدِ',
              'يَا إِمَامُ الْمَسْجِدِ',
              'يَا إِمَامٍ الْمَسْجِدِ',
            ],
          },
          {
            emoji: '👬',
            question_ar: 'صَدِيقُ مَحْمُودٍ → يَا ___',
            question_en: "Mahmud's friend → O ___",
            correct_ar: 'يَا صَدِيقَ مَحْمُودٍ',
            correct_en: "O Mahmud's friend",
            options_ar: ['يَا صَدِيقَ مَحْمُودٍ', 'يَا صَدِيقُ مَحْمُودٍ', 'يَا صَدِيقٍ مَحْمُودٍ'],
          },
        ],
      },
    },
