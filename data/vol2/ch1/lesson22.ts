  ...
  chunks: [
    {
      ...
      payload: {
        words: [
          ...
          {
            id: 10,
            ar: 'مِظَلَّةٌ / مِظَلَّاتٌ',
            romanized: 'miẓallah / miẓallāt',
            en: 'Umbrella / Umbrellas',
            emoji: '☂️',
          },
          {
            id: 11,
            ar: 'شَجَرَةٌ / أَشْجَارٌ',
            romanized: 'shajarah / ashjār',
            en: 'Tree / Trees',
            emoji: '🌳',
          },
          {
            id: 12,
            ar: 'وَرَقَةٌ / أَوْرَاقٌ',
            romanized: 'waraqah / awrāq',
            en: 'Leaf / Leaves',
            emoji: '🍃',
          },
          {
            id: 13,
            ar: 'زَهْرَةٌ / أَزْهَارٌ',
            romanized: 'zahrah / azhār',
            en: 'Flower / Flowers',
            emoji: '🌸',
          },
          {
            id: 14,
            ar: 'طَائِرَةٌ / طَائِرَاتٌ',
            romanized: "ṭā\'irah / ṭā\'irāt",
            en: 'Airplane / Airplanes',
            emoji: '✈️',
          },
          {
            id: 15,
            ar: 'عَلَمٌ / أَعْلَامٌ',
            romanized: "'alam / a'lām",
            en: 'Flag / Flags',
            emoji: '🚩',
          },
          {
            id: 16,
            ar: 'سَاعَةٌ / سَاعَاتٌ',
            romanized: "sā\'ah / sā\'āt",
            en: 'Watch / Watches',
            emoji: '⌚',
          },
          {
            id: 17,
            ar: 'سَيَّارَةٌ / سَيَّارَاتٌ',
            romanized: 'sayyārah / sayyārāt',
            en: 'Car / Cars',
            emoji: '🚗',
          },
          {
        ...
        rules: [
          {
            ...
            meaning:
              'Non-human (irrational) plurals are treated as feminine singular in Arabic grammar. Use هَذِهِ (not هَؤُلَاءِ) and تِلْكَ (not أُولَئِكَ).',
            examples: [
        ...
        rules: [
          {
            ...
            meaning:
              'Adjectives describing irrational plurals use the feminine singular form (with ة ending), not the plural form.',
            examples: [
              { ar: 'كِتَابٌ جَدِيدٌ → كُتُبٌ جَدِيدَةٌ', en: 'A new book → New books' },
              { ar: 'قَلَمٌ جَيِّدٌ → أَقْلَامٌ جَيِّدَةٌ', en: 'A good pen → Good pens' },
              {
                ar: 'بَيْتٌ جَمِيلٌ → بُيُوتٌ جَمِيلَةٌ',
                en: 'A beautiful house → Beautiful houses',
              },
              { ar: 'بَابٌ وَاسِعٌ → أَبْوَابٌ وَاسِعَةٌ', en: 'A wide door → Wide doors' },
              {
                ar: 'سَاعَةٌ ثَمِينَةٌ → سَاعَاتٌ ثَمِينَةٌ',
                en: 'A precious watch → Precious watches',
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '🖊️',
            question_ar: 'هَذَا قَلَمٌ جَيِّدٌ — هَذِهِ أَقْلَامٌ ___',
            question_en: 'This is a good pen — These are ___ pens',
            correct_ar: 'جَيِّدَةٌ',
            correct_en: 'good (f)',
            options_ar: ['جَيِّدَةٌ', 'جَيِّدٌ', 'جَيِّدُونَ'],
          },
          {
            emoji: '⌚',
            question_ar: 'تِلْكَ سَاعَةٌ ثَمِينَةٌ — تِلْكَ سَاعَاتٌ ___',
            question_en: 'That is a precious watch — Those are ___ watches',
            correct_ar: 'ثَمِينَةٌ',
            correct_en: 'precious (f)',
            options_ar: ['ثَمِينَةٌ', 'ثَمِينٌ', 'ثَمِينُونَ'],
          },
          {
            emoji: '🏠',
            question_ar: 'ذَلِكَ بَيْتٌ جَمِيلٌ — تِلْكَ بُيُوتٌ ___',
            question_en: 'That is a beautiful house — Those are ___ houses',
            correct_ar: 'جَمِيلَةٌ',
            correct_en: 'beautiful (f)',
            options_ar: ['جَمِيلَةٌ', 'جَمِيلٌ', 'جَمِيلُونَ'],
          },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '📚',
            question_ar: 'الْكِتَابُ جَدِيدٌ — الْكُتُبُ ___',
            question_en: 'The book is new — The books are ___',
            correct_ar: 'جَدِيدَةٌ',
            correct_en: 'new (f)',
            options_ar: ['جَدِيدَةٌ', 'جَدِيدٌ', 'جُدُدٌ'],
          },
          {
            emoji: '⌚',
            question_ar: 'السَّاعَةُ ثَمِينَةٌ — السَّاعَاتُ ___',
            question_en: 'The watch is precious — The watches are ___',
            correct_ar: 'ثَمِينَةٌ',
            correct_en: 'precious (f)',
            options_ar: ['ثَمِينَةٌ', 'ثَمِينٌ', 'ثَمِينَاتٌ'],
          },
          {
            emoji: '🖊️',
            question_ar: 'الْقَلَمُ جَيِّدٌ — الْأَقْلَامُ ___',
            question_en: 'The pen is good — The pens are ___',
            correct_ar: 'جَيِّدَةٌ',
            correct_en: 'good (f)',
            options_ar: ['جَيِّدَةٌ', 'جَيِّدٌ', 'جَيِّدُونَ'],
          },
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '📚',
            question_ar: 'كِتَابُ رَاشِدٍ جَدِيدٌ — كُتُبُ رَاشِدٍ ___',
            question_en: "Rashid's book is new — Rashid's books are ___",
            correct_ar: 'جَدِيدَةٌ',
            correct_en: 'new (f)',
            options_ar: ['جَدِيدَةٌ', 'جَدِيدٌ', 'جُدُدٌ'],
          },
          {
            emoji: '🚪',
            question_ar: 'بَابُ الْمَسْجِدِ مَفْتُوحٌ — أَبْوَابُ الْمَسْجِدِ ___',
            question_en: 'The door of the mosque is open — The doors of the mosque are ___',
            correct_ar: 'مَفْتُوحَةٌ',
            correct_en: 'open (f)',
            options_ar: ['مَفْتُوحَةٌ', 'مَفْتُوحٌ', 'مَفْتُوحُونَ'],
          },
          {
            emoji: '🛣️',
            question_ar: 'طُرُقُ هَذِهِ الْمَدِينَةِ ___',
            question_en: 'The roads of this city are ___',
            correct_ar: 'وَاسِعَةٌ',
            correct_en: 'wide (f)',
            options_ar: ['وَاسِعَةٌ', 'وَاسِعٌ', 'وَاسِعُونَ'],
          },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '🚢',
            question_ar: 'غَرِقَتِ السَّفِينَةُ — ___ السُّفُنُ',
            question_en: 'The ship sank — The ships ___',
            correct_ar: 'غَرِقَتِ',
            correct_en: 'sank (f.sg.)',
            options_ar: ['غَرِقَتِ', 'غَرِقُوا', 'غَرِقَ'],
          },
          {
            emoji: '🐦',
            question_ar: 'خَرَجَ الطَّائِرُ مِنْ قَفَصِهِ — ___ الطُّيُورُ مِنْ أَقْفَاصِهَا',
            question_en: 'The bird went out of its cage — The birds ___ from their cages',
            correct_ar: 'خَرَجَتِ',
            correct_en: 'went out (f.sg.)',
            options_ar: ['خَرَجَتِ', 'خَرَجُوا', 'خَرَجَ'],
          },
        ],
      },
    },
