        ...
        rules: [
          {
            ...
            meaning:
              'إِنَّ puts the subject (اسم إِنَّ) into the accusative case (fatha/fathatayn). The predicate (خبر) stays nominative.',
            examples: [
              {
                ar: 'رَاشِدٌ تِلْمِيذٌ → إِنَّ رَاشِدًا تِلْمِيذٌ',
                en: 'Rashid is a student → Indeed, Rashid is a student',
              },
              {
                ar: 'الْكِتَابُ جَدِيدٌ → إِنَّ الْكِتَابَ جَدِيدٌ',
                en: 'The book is new → Indeed, the book is new',
              },
              {
                ar: 'عَمُّ مَاجِدٍ عَالِمٌ → إِنَّ عَمَّ مَاجِدٍ عَالِمٌ',
                en: "Majid's uncle is a scholar → Indeed, Majid's uncle is a scholar",
              },
            ],
          },
        ],
        ...
        rules: [
          {
            ...
            examples: [
              {
                ar: 'مَاجِدٌ يَفْهَمُ اللُّغَةَ الْعَرَبِيَّةَ → إِنَّ مَاجِدًا يَفْهَمُ اللُّغَةَ الْعَرَبِيَّةَ',
                en: 'Majid understands Arabic → Indeed, Majid understands Arabic',
              },
              {
                ar: 'أَخُونَا يَصْدُقُ دَائِمًا → إِنَّ أَخَانَا يَصْدُقُ دَائِمًا',
                en: 'Our brother always tells the truth → Indeed, our brother always tells the truth',
              },
            ],
          },
        ],
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'Indeed, Allah is our Lord and your Lord. Indeed, Muhammad is the Messenger of Allah ﷺ. Indeed, the Quran is the Book of Allah. Indeed, Islam is the religion of mercy. Indeed, the garden is clean. Indeed, this female student is intelligent. Indeed, your friend is a good scholar. Indeed, the door of Paradise is wide.',
          },
          {
            lines: [
            ...
            translationEn:
              'Majid understands the Arabic language. / Majid understands the Arabic language. / Indeed, Majid understands the Arabic language. Our brother always tells the truth. / Our brother always tells the truth. / Indeed, our brother always tells the truth and never lies. Indeed, Aisha knows sewing. Indeed, the Arabic language is the key to the Quran.',
          },
        ],
      },
    },
