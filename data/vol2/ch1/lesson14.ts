    ...
    chunks: [
        {
            ...
            payload: {
                words: [
                    ...
                    { id: 3, ar: 'التَّنْوِيرُ', romanized: 'at-tanwīr', en: 'Illuminating / Enlightening', emoji: '💡' },
                    { id: 4, ar: 'السَّلَامُ', romanized: 'as-salām', en: 'Greeting / Saying Salam', emoji: '🤝' },
        ...
        },
        {
            ...
            payload: {
                words: [
                    ...
                    { id: 5, ar: 'لِهِدَايَةِ الْعَالَمِ', romanized: "li-hidāyati l-\'ālam", en: 'For the guidance of the world', emoji: '🌍' },
                ],
            },
        },
        {
            ...
            payload: {
                ...
                masdarRows: [
                    { masdar: 'التَّعْلِيمُ', masdarEn: 'to teach', past: 'عَلَّمَ', present: 'يُعَلِّمُ', imperative: 'عَلِّمْ', prohibitive: 'لَا تُعَلِّمْ' },
                    { masdar: 'التَّنْظِيفُ', masdarEn: 'to clean', past: 'نَظَّفَ', present: 'يُنَظِّفُ', imperative: 'نَظِّفْ', prohibitive: 'لَا تُنَظِّفْ' },
                    { masdar: 'التَّنْوِيرُ', masdarEn: 'to illuminate', past: 'نَوَّرَ', present: 'يُنَوِّرُ', imperative: 'نَوِّرْ', prohibitive: 'لَا تُنَوِّرْ' },
                    { masdar: 'التَّصْدِيقُ', masdarEn: 'to affirm / believe', past: 'صَدَّقَ', present: 'يُصَدِّقُ', imperative: 'صَدِّقْ', prohibitive: 'لَا تُصَدِّقْ' },
                    { masdar: 'التَّكْذِيبُ', masdarEn: 'to deny / consider false', past: 'كَذَّبَ', present: 'يُكَذِّبُ', imperative: 'كَذِّبْ', prohibitive: 'لَا تُكَذِّبْ' },
                    { masdar: 'السَّلَامُ', masdarEn: 'to greet / say salam', past: 'سَلَّمَ', present: 'يُسَلِّمُ', imperative: 'سَلِّمْ', prohibitive: 'لَا تُسَلِّمْ' },
                ],
            },
        },
        {
                ...
                paragraphs: [
                    {
                        ...
                        translationEn: 'Allah sent Muhammad ﷺ to mankind, and sent down to him the Book for the guidance of the world. The people denied him, but Abu Bakr (RA) believed him.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: 'The Messenger of Allah ﷺ taught us everything. The Most Merciful taught the Quran. He created man, He taught him eloquence.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: "O brother of Majid! I want to teach you the Arabic language. O mother of Fatima! Do you want to teach your daughter sewing? Yes, I want to teach her.",
                    },
                    {
                        lines: [
                        ...
                        translationEn: "Fatima's mother said to her daughter: O Fatima! Why don't you clean your room? Enter the room to clean it. Fatima entered the room to clean it.",
                    },
                    {
                        lines: [
                        ...
                        translationEn: 'O Allah! Illuminate my heart with the light of faith. The sun illuminates the earth with its light, and the moon takes light from the sun. Knowledge is light. Knowledge illuminates the heart of the scholar.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: 'O boy! Greet the teacher. This polite boy greets his father and mother in the house, and greets his teacher in the madrasa.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: 'Who taught the bird to fly? Allah taught it. Who taught the bee to gather honey? Allah taught it.',
                    },
                    {
                        lines: [
                            'يَا أُمَّ مَاجِدٍ! عَلِّمِي وَلَدَكِ الصَّغِيرَ الْقُرْآنَ، وَعَلِّمِيهِ الْوُضُوءَ وَالصَّلَاةَ.',
                        ],
                        translationEn: "O mother of Majid! Teach your small boy the Quran, and teach him ablution and prayer.",
                    },
                ],
            },
        },
