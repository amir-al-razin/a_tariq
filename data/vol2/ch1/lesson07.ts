      ...
      payload: {
        words: [
          ...
          { id: 3, ar: 'ظَلَامٌ', romanized: 'ẓalām', en: 'Darkness', emoji: '🌑' },
          {
            id: 4,
            ar: 'لِوَجْهِ اللهِ',
            romanized: 'li-wajhi llāh',
            en: 'For the sake of Allah',
            emoji: '🕌',
          },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        masdarRows: [
          {
            masdar: 'الإِخْرَاجُ',
            masdarEn: 'to bring out',
            past: 'أَخْرَجَ',
            present: 'يُخْرِجُ',
            imperative: 'أَخْرِجْ',
            prohibitive: 'لَا تُخْرِجْ',
          },
          {
            masdar: 'الإِنْزَالُ',
            masdarEn: 'to send down',
            past: 'أَنْزَلَ',
            present: 'يُنْزِلُ',
            imperative: 'أَنْزِلْ',
            prohibitive: 'لَا تُنْزِلْ',
          },
          {
            masdar: 'الإِرْسَالُ',
            masdarEn: 'to send',
      ...
      payload: {
        ...
        masdarRows: [
          ...
          },
          {
            ...
            present: 'يُطِيعُ',
            imperative: 'أَطِعْ',
            prohibitive: 'لَا تُطِعْ',
          },
          {
            masdar: 'الإِقَامَةُ',
            masdarEn: 'to establish / stay',
            past: 'أَقَامَ',
            present: 'يُقِيمُ',
            imperative: 'أَقِمْ',
            prohibitive: 'لَا تُقِمْ',
          },
        ],
      },
    },
      ...
      payload: {
        paragraphs: [
          ...
          },
          {
            ...
            translationEn:
              "Allah sent down the Quran upon His Messenger and brought us out through it from darkness into light. O Muslim! Spend your wealth in the path of Allah. The parent spends his wealth on his child. Majid's mother dressed her son in school clothes and sent him to the madrasa. Allah sent a messenger to Pharaoh.",
          },
          {
            lines: [
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '🚪',
            question_ar: 'خَرَجَ (he exited) → Form IV:',
            question_en: 'What is the Form IV of خَرَجَ?',
            correct_ar: 'أَخْرَجَ (he took out)',
            correct_en: 'أَخْرَجَ (he took out)',
            options_ar: ['أَخْرَجَ (he took out)', 'يَخْرُجُ (he exits)', 'اُخْرُجْ (exit!)'],
          },
          {
            emoji: '⬇️',
            question_ar: 'نَزَلَ (he descended) → Form IV:',
            question_en: 'What is the Form IV of نَزَلَ?',
            correct_ar: 'أَنْزَلَ (he sent down)',
            correct_en: 'أَنْزَلَ (he sent down)',
            options_ar: [
              'أَنْزَلَ (he sent down)',
              'يَنْزِلُ (he descends)',
              'اِنْزِلْ (descend!)',
            ],
          },
          {
            emoji: '🪑',
            question_ar: 'جَلَسَ (he sat) → Form IV:',
            question_en: 'What is the Form IV of جَلَسَ?',
            correct_ar: 'أَجْلَسَ (he seated someone)',
            correct_en: 'أَجْلَسَ (he seated someone)',
            options_ar: ['أَجْلَسَ (he seated someone)', 'يَجْلِسُ (he sits)', 'اِجْلِسْ (sit!)'],
          },
        ],
      },
    },
    {
      ...
      payload: {
        questions: [
          {
            emoji: '🧑‍🤝‍🧑',
            question_ar: 'هَلْ تُكْرِمُ ضَيْفَكَ؟',
            question_en: 'Do you honor your guest?',
            correct_ar: 'نَعَمْ .. أُكْرِمُ ضَيْفِي',
            correct_en: 'Yes, I honor my guest.',
            options_ar: [
              'نَعَمْ .. أُكْرِمُ ضَيْفِي',
              'لَا .. لَا أُكْرِمُهُ',
              'أَحْيَانًا أُكْرِمُهُ',
            ],
            questionType: 'hal',
          },
          {
            emoji: '✅',
            question_ar: 'هَلْ تُطِيعُ اللهَ وَرَسُولَهُ؟',
            question_en: 'Do you obey Allah and His Messenger?',
            correct_ar: 'نَعَمْ .. أُطِيعُ اللهَ وَرَسُولَهُ',
            correct_en: 'Yes, I obey Allah and His Messenger.',
            options_ar: [
              'نَعَمْ .. أُطِيعُ اللهَ وَرَسُولَهُ',
              'لَا .. لَا أُطِيعُهُمَا',
              'أُطِيعُ اللهَ فَقَطْ',
            ],
            questionType: 'hal',
          },
          {
            emoji: '💬',
            question_ar: 'مَنْ أَجَابَ عَلَى سُؤَالِ الْمُعَلِّمِ؟',
            question_en: "Who answered the teacher\'s question?",
            correct_ar: 'أَجَابَ التِّلْمِيذُ',
            correct_en: 'The student answered.',
            options_ar: ['أَجَابَ التِّلْمِيذُ', 'أَجَابَ الْمُعَلِّمُ', 'لَمْ يُجِبْ أَحَدٌ'],
