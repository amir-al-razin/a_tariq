...
export const lesson04: LessonData = {
  ...
  chunks: [
        ...
        paragraphs: [
          {
            ...
            translationEn:
              "Little Rashid said: I understand the speech of Allah because I know the Arabic language. Clever Fatima said: I understood today's lesson well.",
          },
          {
            lines: [
          ...
          },
          {
            ...
            translationEn:
              "Rashid opened his book and read the lesson. The teacher listened to Rashid's lesson and said: You have indeed memorized your lesson well. You memorize your lesson well every day. You are a diligent student.",
          },
          {
            lines: [
          ...
          },
          {
            ...
            translationEn:
              'Fatima is now taking off her school clothes and putting on her home clothes, then going to her garden and playing with Zainab. Fatima sits in her room after Maghrib, opens the book and reads the lesson — she memorizes her lesson well.',
          },
          {
            lines: [
            ...
            translationEn:
              'Rashid asked Fatima: O Fatima! Do you know the Arabic language and understand the Book of Allah? Fatima said: Yes, I know the Arabic language and I understand the Book of Allah. The polytheist does not know his Lord. The Muslim drinks honey and does not drink wine, because it is forbidden.',
          },
        ],
      },
    },
    {
      ...
      payload: {
        questions: [
          {
            emoji: '📖',
            question_ar: 'هَلْ نَصَرَ رَاشِدٌ شَاهِدًا؟',
            question_en: 'Did Rashid help Shahid?',
            correct_ar: 'نَعَمْ .. نَصَرَ رَاشِدٌ شَاهِدًا',
            correct_en: 'Yes, Rashid helped Shahid.',
            options_ar: [
              'نَعَمْ .. نَصَرَ رَاشِدٌ شَاهِدًا',
              'لَا .. مَا نَصَرَهُ',
              'نَصَرَ خَالِدًا',
            ],
            questionType: 'hal',
          ...
          {
            emoji: '🗣️',
            question_ar: 'مَنْ نَصَرَ رَاشِدٌ؟',
            question_en: 'Whom did Rashid help?',
            correct_ar: 'نَصَرَ شَاهِدًا',
            correct_en: 'He helped Shahid.',
            options_ar: ['نَصَرَ شَاهِدًا', 'نَصَرَ خَالِدًا', 'نَصَرَ مَاجِدًا'],
            questionType: 'general',
          },
          {
            emoji: '📚',
            question_ar: 'هَلْ يَعْرِفُ خَالِدٌ بِلَالًا؟',
            question_en: 'Does Khalid know Bilal?',
            correct_ar: 'لَا .. لَا يَعْرِفُ خَالِدٌ بِلَالًا',
            correct_en: 'No, Khalid does not know Bilal.',
            options_ar: [
              'لَا .. لَا يَعْرِفُ خَالِدٌ بِلَالًا',
              'نَعَمْ .. يَعْرِفُهُ',
              'نَعَمْ .. يَعْرِفُهُ جَيِّدًا',
            ],
            questionType: 'hal',
          },
          {
            emoji: '🖊️',
            question_ar: 'بِمَ مَسَحَ رَاشِدٌ السَّبُّورَةَ؟',
            question_en: 'With what did Rashid wipe the board?',
            correct_ar: 'مَسَحَ السَّبُّورَةَ بِالْمِسَّاحَةِ',
            correct_en: 'He wiped the board with the eraser.',
            options_ar: [
              'مَسَحَ السَّبُّورَةَ بِالْمِسَّاحَةِ',
              'مَسَحَهَا بِالْمِنْدِيلِ',
              'مَسَحَهَا بِيَدِهِ',
            ],
            questionType: 'general',
          },
          ...
          {
            emoji: '🌙',
            question_ar: 'مَاذَا تَفْعَلُ فَاطِمَةُ بَعْدَ الْمَغْرِبِ؟',
            question_en: 'What does Fatima do after Maghrib?',
            correct_ar: 'تَجْلِسُ فِي غُرْفَتِهَا وَتَقْرَأُ الدَّرْسَ',
            correct_en: 'She sits in her room and reads the lesson.',
            options_ar: [
              'تَجْلِسُ فِي غُرْفَتِهَا وَتَقْرَأُ الدَّرْسَ',
              'تَلْعَبُ مَعَ زَيْنَبَ',
    ...
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '👤',
            question_ar: 'يَعْرِفُ خَالِدٌ ___',
            question_en: 'Khalid knows ___.',
            correct_ar: 'بِلَالًا',
            correct_en: 'Bilal',
            options_ar: ['بِلَالًا', 'بِلَالٌ', 'بِلَالٍ'],
          },
          {
            emoji: '👧',
            question_ar: 'نَصَرَتْ فَاطِمَةُ ___',
            question_en: 'Fatima helped ___.',
            correct_ar: 'عَائِشَةَ',
            correct_en: 'Aisha',
            options_ar: ['عَائِشَةَ', 'عَائِشَةُ', 'عَائِشَةٍ'],
          },
          {
            emoji: '📖',
            question_ar: 'يَقْرَأُ بِلَالٌ ___ وَأَنَا أَسْمَعُ ___',
            question_en: 'Bilal reads a ___ and I listen to the ___.',
            correct_ar: 'قِصَّةً',
            correct_en: 'story',
            options_ar: ['قِصَّةً', 'قِصَّةٌ', 'قِصَّةٍ'],
          },
          {
            emoji: '💪',
            question_ar: 'أَنْتَ نَصَرْتَ ___',
            question_en: 'You helped ___.',
            correct_ar: 'رَجُلًا ضَعِيفًا',
            correct_en: 'a weak man',
            options_ar: ['رَجُلًا ضَعِيفًا', 'رَجُلٌ ضَعِيفٌ', 'رَجُلٍ ضَعِيفٍ'],
          },
        ],
      },
    },
    {
      ...
      payload: {
        instruction:
          "The word in brackets is nominative. Choose its correct accusative (maf\'ul bihi) form.",
        questions: [
          {
            emoji: '🤲',
            question_ar: 'تَغْسِلُ فَاطِمَةُ ___ قَبْلَ الْأَكْلِ (يَدُهَا)',
            question_en: 'Fatima washes ___ before eating.',
            correct_ar: 'يَدَهَا',
            correct_en: 'her hand',
            options_ar: ['يَدَهَا', 'يَدُهَا', 'يَدِهَا'],
          },
          {
            emoji: '🖊️',
            question_ar: 'مَسَحَ رَاشِدٌ ___ بِالْمِسَّاحَةِ (السَّبُّورَةُ)',
            question_en: 'Rashid wiped ___ with the eraser.',
            correct_ar: 'السَّبُّورَةَ',
            correct_en: 'the board',
            options_ar: ['السَّبُّورَةَ', 'السَّبُّورَةُ', 'السَّبُّورَةِ'],
          },
          {
            emoji: '👗',
            question_ar: 'لَبِسَتْ أُخْتُ مَاجِدٍ ___ (لِبَاسٌ جَمِيلٌ)',
            question_en: "Majid\'s sister wore ___.",
            correct_ar: 'لِبَاسًا جَمِيلًا',
            correct_en: 'beautiful clothes',
            options_ar: ['لِبَاسًا جَمِيلًا', 'لِبَاسٌ جَمِيلٌ', 'لِبَاسٍ جَمِيلٍ'],
          },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '📖',
            question_ar: 'هَلْ تَفْهَمُ كَلَامَ اللهِ؟',
            question_en: 'Do you understand the speech of Allah?',
            correct_ar: 'نَعَمْ .. أَفْهَمُ كَلَامَ اللهِ',
            correct_en: 'Yes, I understand the speech of Allah.',
            options_ar: [
          ...
          {
            emoji: '❓',
            question_ar: 'أَلَا تَفْهَمُ كَلَامَ اللهِ؟',
            question_en: 'Do you not understand the speech of Allah?',
            correct_ar: 'بَلَى .. أَفْهَمُهُ',
            correct_en: 'On the contrary, I do understand it.',
            options_ar: [
              'بَلَى .. أَفْهَمُهُ',
              'نَعَمْ .. لَا أَفْهَمُهُ',
              'لَا .. مَا أَفْهَمُهُ',
            ],
          },
        ],
