  ...
  chunks: [
    {
      ...
      payload: {
        words: [
          ...
          {
            id: 7,
            ar: 'صَاحِبُ الْبَيْتِ',
            romanized: 'ṣāḥibu l-bayt',
            en: 'Owner (m) of the house',
            emoji: '🏠',
          },
          {
            id: 8,
            ar: 'صَاحِبَةُ الْبَيْتِ',
            romanized: 'ṣāḥibatu l-bayt',
            en: 'Owner (f) of the house',
            emoji: '🏠',
          },
          {
            id: 9,
            ar: 'الزِّيَارَةُ',
            romanized: 'az-ziyārah',
            en: 'Visiting / meeting',
            emoji: '🤝',
          },
          ...
          },
          {
            id: 12,
            ar: 'الإِسْتِطَاعَةُ',
            romanized: "al-istiṭā\'ah",
            en: 'Being able to / capability',
            emoji: '💪',
          },
          {
            id: 13,
    ...
    },
    {
      ...
      payload: {
        ...
        masdarRows: [
          {
            masdar: 'الإِسْتِعْمَالُ',
            masdarEn: 'to use',
            past: 'اِسْتَعْمَلَ',
            present: 'يَسْتَعْمِلُ',
            imperative: 'اِسْتَعْمِلْ',
            prohibitive: 'لَا تَسْتَعْمِلْ',
          },
          {
            masdar: 'الإِسْتِغْفَارُ',
            masdarEn: 'to seek forgiveness',
            past: 'اِسْتَغْفَرَ',
            present: 'يَسْتَغْفِرُ',
            imperative: 'اِسْتَغْفِرْ',
            prohibitive: 'لَا تَسْتَغْفِرْ',
          },
          {
            masdar: 'الإِسْتِطْعَامُ',
            masdarEn: 'to ask for food',
            past: 'اِسْتَطْعَمَ',
            present: 'يَسْتَطْعِمُ',
            imperative: 'اِسْتَطْعِمْ',
            prohibitive: 'لَا تَسْتَطْعِمْ',
          },
          {
            masdar: 'الإِسْتِقْبَالُ',
            masdarEn: 'to receive / face',
            past: 'اِسْتَقْبَلَ',
            present: 'يَسْتَقْبِلُ',
            imperative: 'اِسْتَقْبِلْ',
            prohibitive: 'لَا تَسْتَقْبِلْ',
          },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        masdarRows: [
          {
            masdar: 'الإِسْتِرَاحَةُ',
            masdarEn: 'to rest',
            past: 'اِسْتَرَاحَ',
            present: 'يَسْتَرِيحُ',
            imperative: 'اِسْتَرِحْ',
            prohibitive: 'لَا تَسْتَرِحْ',
          },
          {
            masdar: 'الإِسْتِعَانَةُ',
            masdarEn: 'to seek help',
            past: 'اِسْتَعَانَ',
            present: 'يَسْتَعِينُ',
            imperative: 'اِسْتَعِنْ',
            prohibitive: 'لَا تَسْتَعِنْ',
          },
          {
            masdar: 'الإِسْتِطَاعَةُ',
            masdarEn: 'to be able to',
            past: 'اِسْتَطَاعَ',
            present: 'يَسْتَطِيعُ',
            imperative: 'اِسْتَطِعْ',
            prohibitive: 'لَا تَسْتَطِعْ',
          },
          {
            masdar: 'الإِسْتِشَارَةُ',
            masdarEn: 'to consult',
            past: 'اِسْتَشَارَ',
            present: 'يَسْتَشِيرُ',
            imperative: 'اِسْتَشِرْ',
            prohibitive: 'لَا تَسْتَشِرْ',
          },
        ],
      },
    },
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'Fatima is the owner of this house. Fatima said: A hungry poor man stood at the door of the house and asked me for food, so I brought him food and fed him. Seek forgiveness from your Lord. I seek forgiveness from Allah, my Lord, for every sin, and I turn to Him in repentance.',
          },
          {
            lines: [
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'The righteous man said in his supplication: O Allah, I am Your weak servant. I seek Your help in obeying You, so help me in obeying You. A righteous friend helps you in obeying Allah.',
          },
          {
            lines: [
          ...
          },
          {
            ...
            translationEn:
              'Khalid said to Majid: I am not able to go with you to the market, because I am very busy. The student is not able to speak in the Arabic language because he did not learn it well. O smart brother of Majid! Consult Majid in this matter. O smart Majid! I want to consult you in this matter.',
          },
        ],
      },
    },
    {
      ...
      payload: {
        questions: [
          {
            emoji: '🍽️',
            question_ar: 'لِمَ قَامَ الْفَقِيرُ الْجَائِعُ عَلَى بَابِ الْبَيْتِ؟',
            question_en: 'Why did the hungry poor man stand at the door of the house?',
            correct_ar: 'قَامَ لِيَسْتَطْعِمَ صَاحِبَةَ الْبَيْتِ',
            correct_en: 'He stood to ask the lady of the house for food.',
            options_ar: [
              'قَامَ لِيَسْتَطْعِمَ صَاحِبَةَ الْبَيْتِ',
              'قَامَ لِيَسْتَرِيحَ',
              'قَامَ لِيَسْأَلَ عَنِ الطَّرِيقِ',
            ],
            questionType: 'general',
          },
          {
            emoji: '🤲',
            question_ar: 'هَلْ تَسْتَغْفِرُ اللهَ وَتَتُوبُ إِلَيْهِ كُلَّ يَوْمٍ؟',
            question_en: 'Do you seek forgiveness from Allah and repent to Him every day?',
            correct_ar: 'نَعَمْ .. أَسْتَغْفِرُ اللهَ وَأَتُوبُ إِلَيْهِ',
            correct_en: 'Yes, I seek forgiveness from Allah and repent to Him.',
            options_ar: [
              'نَعَمْ .. أَسْتَغْفِرُ اللهَ وَأَتُوبُ إِلَيْهِ',
              'لَا .. لَا أَسْتَغْفِرُ',
              'أَحْيَانًا',
            ],
            questionType: 'hal',
          },
          {
            emoji: '🕌',
            question_ar: 'مَاذَا يَسْتَقْبِلُ الْمُسْلِمُ فِي صَلَاتِهِ؟',
            question_en: 'What does the Muslim face in his prayer?',
            correct_ar: 'يَسْتَقْبِلُ الْقِبْلَةَ',
            correct_en: 'He faces the Qiblah.',
            options_ar: [
              'يَسْتَقْبِلُ الْقِبْلَةَ',
              'يَسْتَقْبِلُ الشَّمْسَ',
              'يَسْتَقْبِلُ الشَّمَالَ',
            ],
            questionType: 'general',
          },
          {
            emoji: '💪',
            question_ar: 'لِمَ لَا يَسْتَطِيعُ الطَّالِبُ أَنْ يَتَكَلَّمَ بِالْعَرَبِيَّةِ؟',
            question_en: 'Why is the student not able to speak in Arabic?',
            correct_ar: 'لِأَنَّهُ مَا تَعَلَّمَهَا جَيِّدًا',
            correct_en: 'Because he did not learn it well.',
            options_ar: [
              'لِأَنَّهُ مَا تَعَلَّمَهَا جَيِّدًا',
              'لِأَنَّهُ لَا يُرِيدُ',
              'لِأَنَّهُ مَشْغُولٌ',
            ],
            questionType: 'general',
          },
