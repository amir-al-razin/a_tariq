...
export const lesson10: LessonData = {
    ...
    chunks: [
                ...
                paragraphs: [
                    {
                        ...
                        translationEn: 'I want to drink Zamzam water. Majid\'s brother wants to drink cold water. Aisha\'s friend wanted to drink grape juice. O brother of Majid! You want to drink honey. O friend of Zainab! You want to drink cow\'s milk. I do not want to drink this juice, because it is sour.',
                    },
                    {
                        lines: [
                        ...
                        translationEn: "Bilal's son wanted to go to the madrasa, so he took off his home clothes, put on his school clothes, then exited the house. I am an honest merchant; I want to spend my wealth in the path of Allah. Allah wanted to bring people out of darkness into light, so He sent His Messenger and revealed the Book to him.",
                    },
                ],
            },
        },
        {
            ...
            payload: {
                questions: [
                    { emoji: '💧', question_ar: 'مَاذَا يُرِيدُ أَخُو مَاجِدٍ؟', question_en: "What does Majid's brother want?", correct_ar: 'يُرِيدُ أَنْ يَشْرَبَ مَاءً بَارِدًا', correct_en: 'He wants to drink cold water.', options_ar: ['يُرِيدُ أَنْ يَشْرَبَ مَاءً بَارِدًا', 'يُرِيدُ أَنْ يَأْكُلَ', 'يُرِيدُ أَنْ يَنَامَ'], questionType: 'general' },
                    { emoji: '🍇', question_ar: 'مَاذَا أَرَادَتْ صَدِيقَةُ عَائِشَةَ؟', question_en: "What did Aisha's friend want?", correct_ar: 'أَرَادَتْ أَنْ تَشْرَبَ عَصِيرَ الْعِنَبِ', correct_en: 'She wanted to drink grape juice.', options_ar: ['أَرَادَتْ أَنْ تَشْرَبَ عَصِيرَ الْعِنَبِ', 'أَرَادَتْ أَنْ تَشْرَبَ لَبَنًا', 'أَرَادَتْ أَنْ تَشْرَبَ مَاءً'], questionType: 'general' },
                    { emoji: '🍯', question_ar: 'يَا أَخَا مَاجِدٍ! هَلْ تُرِيدُ أَنْ تَشْرَبَ عَسَلًا؟', question_en: "O brother of Majid! Do you want to drink honey?", correct_ar: 'نَعَمْ .. أُرِيدُ أَنْ أَشْرَبَ عَسَلًا', correct_en: 'Yes, I want to drink honey.', options_ar: ['نَعَمْ .. أُرِيدُ أَنْ أَشْرَبَ عَسَلًا', 'لَا .. لَا أُرِيدُ', 'أُرِيدُ عَصِيرًا'], questionType: 'hal' },
                    { emoji: '🥛', question_ar: 'يَا صَدِيقَةَ زَيْنَبَ! مَاذَا تُرِيدِينَ أَنْ تَشْرَبِي؟', question_en: "O friend of Zainab! What do you want to drink?", correct_ar: 'أُرِيدُ أَنْ أَشْرَبَ لَبَنَ الْبَقَرِ', correct_en: "I want to drink cow's milk.", options_ar: ['أُرِيدُ أَنْ أَشْرَبَ لَبَنَ الْبَقَرِ', 'أُرِيدُ أَنْ أَشْرَبَ عَصِيرًا', 'أُرِيدُ مَاءً'], questionType: 'general' },
                    { emoji: '🏫', question_ar: 'مَاذَا أَرَادَ وَلَدُ بِلَالٍ؟', question_en: "What did Bilal's son want?", correct_ar: 'أَرَادَ أَنْ يَذْهَبَ إِلَى الْمَدْرَسَةِ', correct_en: 'He wanted to go to the madrasa.', options_ar: ['أَرَادَ أَنْ يَذْهَبَ إِلَى الْمَدْرَسَةِ', 'أَرَادَ أَنْ يَلْعَبَ', 'أَرَادَ أَنْ يَنَامَ'], questionType: 'general' },
                ],
            },
        },
    ],
