        ...
        rules: [
          ...
          },
          {
            ...
            examples: [
              ...
              {
                ar: 'أَمَا ذَهَبْتَ ؟ — نَعَمْ (مَا ذَهَبْتُ) / بَلَى (ذَهَبْتُ)',
                en: "Didn't you go? — Right, I didn't / Yes I did.",
              },
            ],
          },
        ],
        ...
        verbTable: [
          {
            ...
            she: 'لَا تَفْعَلُ',
            youM: 'لَا تَفْعَلُ',
            youF: 'لَا تَفْعَلِينَ',
            i: 'لَا أَفْعَلُ',
          },
          {
            root: 'لَا يَخْرُجُ',
            meaning: 'does not exit',
            he: 'لَا يَخْرُجُ',
            she: 'لَا تَخْرُجُ',
            youM: 'لَا تَخْرُجُ',
            youF: 'لَا تَخْرُجِينَ',
            i: 'لَا أَخْرُجُ',
          },
          {
            root: 'لَا يَذْهَبُ',
            ...
            she: 'لَا تَذْهَبُ',
            youM: 'لَا تَذْهَبُ',
            youF: 'لَا تَذْهَبِينَ',
            i: 'لَا أَذْهَبُ',
          },
          {
            root: 'لَا يَكْتُبُ',
            meaning: 'does not write',
            he: 'لَا يَكْتُبُ',
            she: 'لَا تَكْتُبُ',
            youM: 'لَا تَكْتُبُ',
            youF: 'لَا تَكْتُبِينَ',
            i: 'لَا أَكْتُبُ',
          },
        ],
      },
        ...
        paragraphs: [
          {
            ...
            translationEn:
              "Shahid went to the madrasa but Shahid's brother did not go. Su'ad did not exit her room and did not play in the garden, rather she read and wrote. Su'ad did not go to her bed before Isha, rather after Isha.",
          },
          {
            lines: [
            ...
            translationEn:
              'A person does not write with his left hand, rather he writes with his right. No one returns to this world after death. The believer will never exit Paradise and the polytheist will never exit the Fire.',
          },
        ],
      },
    },
        ...
        questions: [
          {
            ...
            question_en: "Did Shahid's brother go to the madrasa?",
            correct_ar: 'لَا .. مَا ذَهَبَ',
            correct_en: 'No, he did not go.',
            options_ar: ['لَا .. مَا ذَهَبَ', 'نَعَمْ .. ذَهَبَ', 'بَلَى .. ذَهَبَ'],
            questionType: 'hal',
          },
          {
            emoji: '📖',
            question_ar: 'مَاذَا فَعَلَتْ سُعَادُ ؟',
            question_en: "What did Su\'ad do?",
            correct_ar: 'قَرَأَتْ وَكَتَبَتْ',
            correct_en: 'She read and wrote.',
            options_ar: [
              'قَرَأَتْ وَكَتَبَتْ',
              'لَعِبَتْ فِي الْحَدِيقَةِ',
          ...
          },
          {
            ...
            question_en: "When did Su'ad go to her bed?",
            correct_ar: 'ذَهَبَتْ بَعْدَ الْعِشَاءِ',
            correct_en: 'She went after Isha.',
            options_ar: [
              'ذَهَبَتْ بَعْدَ الْعِشَاءِ',
              'ذَهَبَتْ قَبْلَ الْعِشَاءِ',
              'ذَهَبَتْ صَبَاحًا',
            ],
            questionType: 'general',
          },
          {
            emoji: '✍️',
            question_ar: 'أَبِشِمَالِهِ يَكْتُبُ الْإِنْسَانُ أَمْ بِيَمِينِهِ ؟',
            question_en: 'Does a person write with his left or right hand?',
            correct_ar: 'يَكْتُبُ بِيَمِينِهِ',
            correct_en: 'He writes with his right hand.',
            options_ar: ['يَكْتُبُ بِيَمِينِهِ', 'يَكْتُبُ بِشِمَالِهِ', 'يَكْتُبُ بِكِلَيْهِمَا'],
            questionType: 'a_am',
          },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        questions: [
          {
            emoji: '🏃',
            question_ar: 'خَرَجَ رَاشِدٌ مِنَ الْبَيْتِ (نَفْيٌ)',
            question_en: 'Rashid exited the house. (Negate it)',
            correct_ar: 'مَا خَرَجَ رَاشِدٌ مِنَ الْبَيْتِ',
            correct_en: 'Rashid did not exit the house.',
            options_ar: [
              'مَا خَرَجَ رَاشِدٌ مِنَ الْبَيْتِ',
              'لَا يَخْرُجُ رَاشِدٌ مِنَ الْبَيْتِ',
              'لَمْ يَخْرُجْ رَاشِدٌ',
            ],
          },
          {
            emoji: '📚',
            question_ar: 'يَقْرَأُ خَالِدٌ كُلَّ يَوْمٍ (نَفْيٌ)',
            question_en: 'Khalid reads every day. (Negate it)',
            correct_ar: 'لَا يَقْرَأُ خَالِدٌ كُلَّ يَوْمٍ',
            correct_en: 'Khalid does not read every day.',
            options_ar: [
              'لَا يَقْرَأُ خَالِدٌ كُلَّ يَوْمٍ',
              'مَا قَرَأَ خَالِدٌ كُلَّ يَوْمٍ',
              'لَا قَرَأَ خَالِدٌ',
            ],
          },
          {
            emoji: '🌿',
            question_ar: 'أَمَا ذَهَبْتَ إِلَى الْمَدْرَسَةِ ؟ (الجَوَاب: بَلَى)',
            question_en: "Didn't you go to the madrasa? (Answer: Yes I did)",
            correct_ar: 'بَلَى .. ذَهَبْتُ',
            correct_en: 'Yes I did go.',
            options_ar: ['بَلَى .. ذَهَبْتُ', 'نَعَمْ .. مَا ذَهَبْتُ', 'لَا .. مَا ذَهَبْتُ'],
          },
        ],
      },
    },
