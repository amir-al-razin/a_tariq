        ...
        rules: [
          {
            ...
            meaning:
              'Combining كَانَ (past) with a present tense verb expresses habitual past or past continuous action.',
            examples: [
        ...
        rules: [
          {
            ...
            meaning:
              'This pattern works with any present tense verb to express past habitual or continuous action',
            examples: [
        ...
        rules: [
          {
            ...
            meaning:
              'The subject can appear in three positions — all are grammatically correct and mean Rashid used to write',
            examples: [
