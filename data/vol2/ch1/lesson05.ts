        ...
        paragraphs: [
          {
            ...
            translationEn:
              'Allah helped us. Allah will help you all. O Allah, protect me. I recognized them today. Rashid asked a new student: Do you know me, O boy? The new student said: Yes, I know you and I know your brother. The new student went to the board, wiped it with the eraser, and wrote a sentence on it.',
          },
          {
            lines: [
            ...
            translationEn:
              'Fatima said to Zainab: O Zainab! I understand the Quran and Hadith but you do not understand them both, because I know the Arabic language and you do not know it. There is a lock on the door. Open it with this key. This is cold milk, do not drink it, O Layla. This is delicious fruit, eat it all, O Bilal.',
          },
        ],
      },
    },
    {
      ...
      payload: {
        questions: [
          {
            emoji: '🙏',
            question_ar: 'مَنْ نَصَرَكُمْ فِي مُصِيبَتِكُمْ؟',
            question_en: 'Who helped you in your hardship?',
            correct_ar: 'نَصَرَنَا اللهُ',
            correct_en: 'Allah helped us.',
            options_ar: ['نَصَرَنَا اللهُ', 'نَصَرَنَا رَاشِدٌ', 'نَصَرَنَا الْمُعَلِّمُ'],
            questionType: 'general',
          },
          {
            emoji: '🌍',
            question_ar: 'مَنْ خَلَقَكَ أَيُّهَا الْمُسْلِمُ؟',
            question_en: 'Who created you, O Muslim?',
            correct_ar: 'خَلَقَنِيَ اللهُ',
            correct_en: 'Allah created me.',
            options_ar: ['خَلَقَنِيَ اللهُ', 'خَلَقَنِي أَبِي', 'لَا أَعْرِفُ'],
            questionType: 'general',
          },
          {
            emoji: '☀️',
            question_ar: 'مَنْ خَلَقَ الشَّمْسَ؟',
            question_en: 'Who created the sun?',
            correct_ar: 'خَلَقَهَا اللهُ',
            correct_en: 'Allah created it.',
            options_ar: ['خَلَقَهَا اللهُ', 'خَلَقَهَا الْإِنْسَانُ', 'لَا أَحَدَ'],
            questionType: 'general',
          },
          {
            emoji: '🌙',
            question_ar: 'مَنْ خَلَقَ الْقَمَرَ؟',
            question_en: 'Who created the moon?',
            correct_ar: 'خَلَقَهُ اللهُ',
            correct_en: 'Allah created it.',
            options_ar: ['خَلَقَهُ اللهُ', 'خَلَقَهُ الْإِنْسَانُ', 'خَلَقَتْهُ الشَّمْسُ'],
            questionType: 'general',
          },
          {
            emoji: '🕌',
            question_ar: 'لِمَنْ تَسْجُدُ أَيُّهَا الْمُسْلِمُ؟',
            question_en: 'To whom do you prostrate, O Muslim?',
            correct_ar: 'أَسْجُدُ لِلهِ',
            correct_en: 'I prostrate to Allah.',
            options_ar: ['أَسْجُدُ لِلهِ', 'أَسْجُدُ لِلشَّجَرِ', 'أَسْجُدُ لِلْحَجَرِ'],
            questionType: 'general',
          },
          {
            emoji: '📖',
            question_ar: 'هَلْ تَفْهَمُ فَاطِمَةُ الْقُرْآنَ وَالْحَدِيثَ؟',
            question_en: 'Does Fatima understand the Quran and Hadith?',
            correct_ar: 'نَعَمْ .. تَفْهَمُهُمَا',
            correct_en: 'Yes, she understands them both.',
            options_ar: [
              'نَعَمْ .. تَفْهَمُهُمَا',
              'لَا .. لَا تَفْهَمُهُمَا',
              'تَفْهَمُ الْقُرْآنَ فَقَطْ',
            ],
            questionType: 'hal',
          },
        ],
