  ...
  chunks: [
    {
      ...
      payload: {
        words: [
          {
            id: 1,
            ar: 'مَنْهَل ج مَنَاهِل',
            romanized: 'manhal pl. manāhil',
            en: 'Water spring / Source',
            bn: 'জলের ঝর্ণা / উৎস',
            emoji: '⛲',
          },
          {
            ...
            ar: 'مَشْكُور',
            romanized: 'mashkūr',
            en: 'Appreciated / Rewardable',
            bn: 'প্রশংসিত / পুরস্কারযোগ্য',
            emoji: '🌟',
          },
          {
            id: 3,
            ar: 'رِحَاب',
            romanized: 'riḥāb',
            en: 'Courtyards / Vast expanses',
            bn: 'আঙিনা / বিশাল প্রান্তর',
            emoji: '🕌',
          },
          {
            id: 4,
            ar: 'تَهُونُ دُونَهَا',
            romanized: 'tahūnu dūnahā',
            en: 'Pales in comparison / Becomes insignificant before it',
            bn: 'এর তুলনায় ফ্যাকাশে হয়ে যায় / এর আগে তুচ্ছ হয়ে যায়',
            emoji: '⬇️',
          },
          {
            id: 5,
            ar: 'دَوَام',
            romanized: 'dawām',
            en: 'Permanence / Continuation',
            bn: 'স্থায়িত্ব / ধারাবাহিকতা',
            emoji: '⏳',
          },
          {
            id: 6,
          ...
          },
          {
            ...
            ar: 'بَاطِل',
            romanized: 'bāṭil',
            en: 'Falsehood / False deities',
            bn: 'মিথ্যা / মিথ্যা দেবতা',
            emoji: '❌',
          },
          {
            id: 8,
            ar: 'طَاغُوت',
            romanized: 'ṭāghūt',
            en: 'False deity / Tyrant / Rebel against God',
            bn: 'মিথ্যা দেবতা / স্বৈরাচারী / ঈশ্বরের বিরুদ্ধে বিদ্রোহী',
            emoji: '👿',
          },
          {
            id: 9,
            ar: 'اِحْذَرُوهُ (الحذر، س)',
            romanized: 'iḥdharūhu (al-ḥadhar, s)',
            en: 'Beware of Him / Fear Him',
            bn: 'তাঁর থেকে সাবধান থাকুন / তাঁকে ভয় করুন',
            emoji: '⚠️',
          },
          {
            id: 10,
            ar: 'وَلِيّ ج أَوْلِيَاء',
            romanized: 'walīy pl. awliyāʾ',
            en: 'Guardian / Helper / Friend',
            bn: 'অভিভাবক / সাহায্যকারী / বন্ধু',
            emoji: '🤝',
          },
          {
            id: 11,
            ar: 'مَوْلَى',
            romanized: 'mawlā',
            en: 'Guardian / Helper / Master',
            bn: 'অভিভাবক / সাহায্যকারী / প্রভু',
            emoji: '🛡️',
          },
          {
            id: 12,
            ar: 'أَذِلَّة ج ذَلِيل',
            romanized: 'adhillah pl. dhalīl',
            en: 'Weak / Humiliated / Abased',
            bn: 'দুর্বল / অপমানিত / অবমানিত',
            emoji: '😔',
          },
          {
            id: 13,
            ar: 'بُرْهَان ج بَرَاهِين',
          ...
          { id: 18, ar: 'أَعْمَى', romanized: 'aʿmā', en: 'Blind', bn: 'অন্ধ', emoji: '🦯' },
          {
            ...
            ar: 'بَصِير',
            romanized: 'baṣīr',
            en: 'All-Seeing / Seeing / Endowed with sight',
            bn: 'সর্বদর্শী / দৃষ্টিসম্পন্ন',
            emoji: '👀',
          },
          {
            id: 20,
          ...
          },
          {
            ...
            ar: 'عِوَج',
            romanized: 'ʿiwaj',
            en: 'Crookedness / Deviation',
            bn: 'বক্রতা / বিচ্যুতি',
            emoji: '〰️',
          },
          {
            id: 25,
            ar: 'فُؤَاد ج أَفْئِدَة',
            romanized: 'fuʾād pl. afʾidah',
            en: 'Heart',
            bn: 'হৃদয়',
            emoji: '❤️',
          },
          {
            id: 26,
            ar: 'النَّفَاد (س)',
            romanized: 'an-nafād (s)',
            en: 'Depletion / Exhaustion',
            bn: 'ক্ষয় / ক্লান্তি',
            emoji: '📉',
          },
          {
            ...
            ar: 'وَكِيل',
            romanized: 'wakīl',
            en: 'Guardian / Trustee / Disposer of affairs',
            bn: 'অভিভাবক / ট্রাস্টি / কর্ম নির্বাহক',
            emoji: '⚖️',
          },
          {
            id: 28,
            ar: 'فَلَك ج أَفْلَاك',
            romanized: 'falak pl. aflāk',
            en: 'Orbit',
            bn: 'কক্ষপথ',
            emoji: '🪐',
          },
          {
            ...
            ar: 'كَرْب',
            romanized: 'karb',
            en: 'Distress / Anguish / Disaster',
            bn: 'কষ্ট / যন্ত্রণা / বিপর্যয়',
            emoji: '😢',
          },
          {
            id: 30,
            ar: 'سُبْحَانَكَ',
            romanized: 'subḥānaka',
            en: 'Glory be to You / I declare Your absolute purity',
            bn: 'আপনার মহিমা / আমি আপনার পরম পবিত্রতা ঘোষণা করি',
            emoji: '✨',
          },
          {
            id: 31,
            ar: 'تَجْرِي (الجريان، ض)',
            romanized: 'tajrī (al-jarayān, ḍ)',
            en: 'Flows / Runs',
            bn: 'প্রবাহিত হয় / ছুটে চলে',
            emoji: '🌊',
          },
          {
            id: 32,
            ...
            en: 'Immorality / Obscenity / Obscene deeds',
            bn: 'অনৈতিকতা / অশ্লীলতা',
            emoji: '🚫',
          },
          {
            id: 33,
          ...
          },
          {
            ...
            ar: 'شُيُوع (ض)',
            romanized: 'shuyūʿ (ḍ)',
            en: 'Spreading / Becoming public',
            bn: 'ছড়িয়ে পড়া / প্রকাশ্যে আসা',
            emoji: '📢',
          },
          {
            id: 37,
          ...
          },
          {
            ...
            romanized: 'dhakkara',
            en: 'Reminded / Advised',
            bn: 'স্মরণ করিয়ে দিয়েছিল / পরামর্শ দিয়েছিল',
            emoji: '💡',
          },
          {
            id: 39,
          ...
          { id: 40, ar: 'عَيْن', romanized: 'ʿayn', en: 'Eye', bn: 'চোখ', emoji: '👁️' },
          {
            ...
            ar: 'دَافِع',
            romanized: 'dāfiʿ',
            en: 'Preventer / Defender',
            bn: 'প্রতিরোধকারী / রক্ষক',
            emoji: '🛡️',
          },
          {
            id: 42,
            ar: 'حِزْب ج أَحْزَاب',
            romanized: 'ḥizb pl. aḥzāb',
        ...
        paragraphs: [
          {
            ...
            translationBn: '(১) পরম করুণাময়, অসীম দয়ালু আল্লাহর নামে। আমাদের সরল পথ দেখান।',
          },
          {
            titleEn: 'Worshipping the Creator',
            titleBn: 'স্রষ্টার উপাসনা',
            lines: ['(٢) يَأَيُّهَا النَّاسُ اعْبُدُواْ رَبَّكُمُ الَّذِي خَلَقَكُمْ'],
            translationEn: '(2) O mankind, worship your Lord, who created you.',
            translationBn: '(২) হে মানবজাতি, তোমাদের রবের ইবাদত কর, যিনি তোমাদের সৃষ্টি করেছেন।',
          },
          {
            titleEn: 'Dwelling in Paradise',
            titleBn: 'জান্নাতে বসবাস',
            lines: ['(٣) وَ قُلْنَا يَا آدَمُ اسْكُنْ أَنْتَ وَ زَوْجُكَ الْجَنَّةَ'],
            translationEn: '(3) And We said, "O Adam, dwell, you and your wife, in Paradise."',
            translationBn: '(৩) আর আমরা বললাম, "হে আদম, তুমি এবং তোমার স্ত্রী জান্নাতে বসবাস কর।"',
          },
          {
            titleEn: 'Consuming Provision',
            titleBn: 'রিজিক গ্রহণ',
            lines: ['(٤) كُلُواْ وَ اشْرَبُواْ مِنْ رِزْقِ اللَّهِ'],
            translationEn: '(4) Eat and drink from the provision of Allah.',
            translationBn: '(৪) আল্লাহর দেওয়া রিজিক থেকে খাও ও পান কর।',
          },
          {
            ...
            translationBn: '(৫) আর যারা ঈমান আনে এবং সৎ কাজ করে - তারাই জান্নাতের অধিবাসী।',
          },
          {
