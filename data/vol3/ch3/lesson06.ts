      ...
      payload: {
        words: [
          ...
          },
          {
            ...
            bn: 'প্রকাশিত হওয়া / উন্মোচিত হওয়া',
            emoji: '🔍',
          },
          {
            id: 5,
            ...
            bn: 'অসুস্থতার ভান করা',
            emoji: '🤒',
          },
          {
            id: 6,
            ar: 'التَّنَاوُم',
            romanized: 'at-tanāwum',
            en: 'Feigning sleep',
            bn: 'ঘুমের ভান করা',
            emoji: '😴',
          },
          {
            ...
            bn: 'পারস্পরিক পরামর্শ',
            emoji: '💬',
          },
          {
            id: 8,
            ar: 'التَّقَاتُل',
            romanized: 'at-taqātul',
            en: 'Mutual fighting',
            bn: 'পারস্পরিক লড়াই',
            emoji: '⚔️',
          },
      ...
      payload: {
        rules: [
          ...
          },
          {
            ...
            meaningBn:
              'কোনো কাজ করার ভান করা, অথবা পারস্পরিকভাবে করা কোনো কাজ বোঝায় যার জন্য দুই বা ততোধিক কর্তা প্রয়োজন।',
            examples: [
              {
                ar: 'مَا مَرِضَ الرَّجُلُ بَلْ تَمَارَضَ',
                en: 'The man did not get sick, but he feigned sickness',
                bn: 'লোকটি অসুস্থ হয়নি, বরং সে অসুস্থতার ভান করেছে',
              },
              {
                ar: 'تَشَاوَرَ الرَّجُلَانِ',
                en: 'The two men consulted each other',
                bn: 'দুজন লোক একে অপরের সাথে পরামর্শ করল',
              },
            ],
          },
        ],
        ...
        paragraphs: [
          {
            ...
            translationEn:
              'If you say: "The man conversed (mutually)", you are wrong, because this verb requires two subjects or more. So you must say: "The two men conversed". I hope that you have understood the matter very well.',
            translationBn:
              'যদি তুমি বলো: "লোকটি (পারস্পরিক) কথা বলল", তবে তুমি ভুল করছ, কারণ এই ক্রিয়াপদে দুই বা ততোধিক কর্তার প্রয়োজন হয়। তাই তোমাকে অবশ্যই বলতে হবে: "দুজন লোক কথা বলল"। আমি আশা করি তুমি বিষয়টি ভালোভাবে বুঝতে পেরেছ।',
          },
        ],
      },
    },
