        ...
        words: [
          {
            ...
            ar: 'سَخِطَ',
            romanized: 'sakhiṭa',
            en: 'To be angry / to anger',
            bn: 'রাগ করা / রাগান্বিত করা',
            emoji: '😠',
          },
          {
            id: 2,
      ...
      payload: {
        rules: [
          ...
          },
          {
            ...
            examples: [{ ar: 'لَنْ نَنْسَى', en: 'We will not forget', bn: 'আমরা ভুলব না' }],
          },
          {
            ...
            meaningBn:
              'পুংলিঙ্গ বহুবচন এবং মধ্যম পুরুষ স্ত্রীলিঙ্গ একবচনের ক্ষেত্রে, নসব অবস্থা বোঝাতে শেষের নুন (ن) বাদ দেওয়া হয়।',
            examples: [
              {
                ar: 'لَنْ يَسْقُوا',
                en: 'They (m.) will not give drink',
                bn: 'তারা (পুরুষ) পান করাবে না',
              },
            ],
          },
          {
            ...
            meaningBn:
              'স্ত্রীলিঙ্গ বহুবচনের ক্ষেত্রে নুন (ن) থেকে যায়, কারণ এটি স্থায়ী স্ত্রীলিঙ্গ সর্বনাম।',
            examples: [
      ...
      payload: {
        ...
        questions: [
          ...
          },
          {
            ...
            options_ar: [
              'أَنْ يَقْرَؤُوا أَخْبَارَ الصَّالِحِينَ',
