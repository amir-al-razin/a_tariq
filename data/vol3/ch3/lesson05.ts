        ...
        rules: [
          {
            ...
            meaningBn:
              'إِنْ দুটি বর্তমান কালের ক্রিয়ার (শর্ত ও ফলাফল) পূর্বে বসে তাদের মাজজুম (জযমযুক্ত) করে। এটি অতীত কালের ক্রিয়ার পূর্বে বসলে তাদের অর্থ ভবিষ্যতের দিকে পরিবর্তন করে।',
            examples: [
              {
                ar: 'إِنْ تُطِعْ وَالِدَكَ يُطِعْكَ وَلَدُكَ',
                en: 'If you obey your father, your child will obey you',
                bn: 'যদি তুমি তোমার পিতার আনুগত্য করো, তবে তোমার সন্তান তোমার আনুগত্য করবে',
              },
              {
                ar: 'إِنْ يَجْتَهِدُوا يَنْجَحُوا',
                en: 'If they strive, they will succeed',
                bn: 'যদি তারা প্রচেষ্টা করে, তবে তারা সফল হবে',
              },
            ],
          },
          {
            ...
            meaningBn:
              'শর্তের ফলাফলে (জওয়াবুল শর্ত) فَ যুক্ত করা হয় যখন ফলাফলটি একটি আদেশ, অনুরোধ বা সাধারণ ক্রিয়ার উত্তর হতে পারে না।',
            examples: [
              {
                ...
                bn: 'যদি কোনো দরিদ্র ব্যক্তি তোমার দরজায় দাঁড়ায়, তবে তাকে দান করো',
              },
            ],
          },
          {
            ...
            meaningBn:
              'إِذَا সময় বা পরিস্থিতির বিশেষ্য এবং এটি শর্তের (যখন/যদি) অর্থ নিয়েও আসতে পারে।',
            examples: [
              {
                ar: 'إِذَا دَعَوْتَنِي أَجَبْتُكَ',
                en: 'When/if you call me, I answer you',
                bn: 'যখন/যদি তুমি আমাকে ডাকো, আমি তোমার ডাকে সাড়া দেব',
              },
            ],
          },
          {
            ...
            examples: [
              {
                ...
                bn: 'যদি আমার কাছে সম্পদ থাকত, আমি তোমাকে দিতাম',
              },
            ],
          },
        ],
        ...
        paragraphs: [
          {
            ...
            translationBn:
              'যদি তোমরা আল্লাহকে সাহায্য করো, তিনি তোমাদের সাহায্য করবেন এবং তোমাদের পা দৃঢ় রাখবেন। যদি তোমরা আল্লাহ ও তাঁর রাসূলের আনুগত্য করো, তিনি তোমাদের জান্নাতে প্রবেশ করাবেন এবং তোমাদের মহাপুরস্কার দান করবেন। যদি তোমরা আল্লাহর পথে তোমাদের সম্পদ ব্যয় করো, তবে তোমরা আল্লাহর কাছে এর প্রতিদান পাবে। হে বালক! যদি তুমি আরবি ভাষা শেখো, তবে তুমি কুরআন বুঝতে পারবে এবং কুরআনের মাধুর্য পাবে। যদি তুমি তোমার মূল্যবান সময় খেলাধুলা ও বিনোদনে নষ্ট করো, তবে তোমার ভবিষ্যৎ নষ্ট হয়ে যাবে। আল্লাহ তাআলা কুরআনে বলেছেন: যারা আল্লাহর পথে নিজেদের সম্পদ ব্যয় করে তাদের উদাহরণ একটি শস্যকণার মতো যা সাতটি শীষ উৎপন্ন করে, প্রতিটি শীষে একশটি দানা থাকে।',
          },
          {
