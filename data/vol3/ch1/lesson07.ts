        ...
        rules: [
          {
            ...
            romanized:
              'fī al-durūs al-māḍiyah qaddamnā al-fard wa al-jamʿ, wa al-ān nuqaddimu afʿāl al-tathnīyah',
            meaning:
            ...
            examples: [
              {
                ar: 'ذَهَبَا (they two went) ↔ يَذْهَبَانِ (they two go)',
                en: 'Dual past ↔ Dual present',
                bn: 'দ্বৈত অতীত ↔ দ্বৈত বর্তমান',
              },
              {
                ar: 'اِذْهَبَا (go! dual) ↔ لَا تَذْهَبَا (do not go! dual)',
                en: 'Dual imperative / negative',
                bn: 'দ্বৈত আদেশ / নিবারণ',
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      payload: {
        masdarRows: [
          ...
          {
            masdar: 'النَّصْر',
            masdarEn: 'help/victory',
            masdarBn: 'জয়/সহায়তা',
            past: 'نَصَرَ',
            present: 'يَنصُرُ',
            imperative: 'انْصُرْ',
    ...
    },
    {
      ...
      payload: {
        ...
        verbTable: [
          {
            root: 'أَرْسَلَ',
            meaning: 'to send/honor',
            meaningBn: 'পাঠানো/সম্মান করা',
            he: 'أَرْسَلَا',
            she: 'أَرْسَلَتَا',
            youM: 'أَرْسَلْتُمَا',
            youF: 'أَرْسَلْتُمَا',
          ...
          },
          {
            ...
            he: 'اِغْتَسَلَا',
            she: 'اِغْتَسَلَتَا',
            youM: 'اِغْتَسَلْتُمَا',
            youF: 'اِغْتَسَلْتُمَا',
            i: 'اِغْتَسَلْنَا',
          },
        ],
      },
      ...
      payload: {
        ...
        verbTable: [
          ...
          },
          {
            ...
            meaningBn: 'কেনা',
            he: 'لَنْ يَشْتَرِيَا',
            she: 'لَنْ تَشْتَرِيَا',
            youM: 'لَنْ تَشْتَرِيَا',
            youF: 'لَنْ تَشْتَرِيَا',
            i: 'لَنْ نَشْتَرِي',
          },
        ],
      },
